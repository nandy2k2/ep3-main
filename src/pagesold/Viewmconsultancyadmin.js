...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/consultancydocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getconsultancycount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getconsultancysecond', {
          params: {
            token: token,
            colid: colid,
            user: user
