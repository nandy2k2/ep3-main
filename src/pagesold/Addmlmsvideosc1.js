...
<p>Keywords to generate sample text</p>
<TextField id="outlined-basic"  type="String" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={keywordsref} /><br /><br />
...
<Button onClick={onButtonClickm}
           ...
           <br /><br />
<p>Voice text (For best result, keep it less than 30 words per slide)</p>
