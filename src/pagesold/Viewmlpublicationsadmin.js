...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/lpublicationsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getlpublicationscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getlpublicationssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
