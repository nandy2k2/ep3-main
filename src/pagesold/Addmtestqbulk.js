...
return;
  ...
  const searchapi = async (rownumber,testid1,question,type,imagelink,videolink,doclink,co,po,module,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      testid,question,type,imagelink,videolink,doclink,co,po,module,status <br /><br />
