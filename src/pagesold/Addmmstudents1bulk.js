...
return;
  ...
  const searchapi = async (rownumber,student,regno,rollno,program,programcode,batch,year,gender,category,pwd,minority,currentyear,currentsem,username,password,enabled,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Registration no' + ',';
return;
}
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Roll no' + ',';
return;
}
if(!row[3]){
...
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Batch' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Admission year' + ',';
return;
}
if(!row[7]){
f1=f1 + 'row ' + rownumber + '-' + 'Gender' + ',';
return;
}
if(!row[8]){
...
if(!row[9]){
f1=f1 + 'row ' + rownumber + '-' + 'Is PWD' + ',';
return;
}
if(!row[10]){
f1=f1 + 'row ' + rownumber + '-' + 'Is minority' + ',';
return;
}
if(!row[11]){
f1=f1 + 'row ' + rownumber + '-' + 'Current academic year' + ',';
return;
}
if(!row[12]){
f1=f1 + 'row ' + rownumber + '-' + 'Current semester' + ',';
return;
}
if(!row[13]){
f1=f1 + 'row ' + rownumber + '-' + 'Username' + ',';
return;
}
if(!row[14]){
...
if(!row[15]){
f1=f1 + 'row ' + rownumber + '-' + 'Is enabled' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      student,regno,rollno,program,programcode,batch,year,gender,category,pwd,minority,currentyear,currentsem,username,password,enabled,status <br /><br />
