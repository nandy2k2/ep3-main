...
return;
  ...
  const searchapi = async (rownumber,year,course,coursecode,module,description,credits,courselink,type,completed,status1) => {
...
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Module link' + ',';
return;
}
if(!row[7]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,course,coursecode,module,description,credits,courselink,type,completed,status <br /><br />
