...
return;
  ...
  const searchapi = async (rownumber,coursecode,title,description,module,type,target,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      coursecode,title,description,module,type,target,status <br /><br />
