...
return;
  ...
  const searchapi = async (rownumber,coursename,coursecode,co,level,minvalue,maxvalue,status1) => {
...
f1=f1 + 'row ' + rownumber + '-' + 'Minimum value' + ',';
return;
}
if(!row[5] || isNaN(row[5])){
f1=f1 + 'row ' + rownumber + '-' + 'Maximum value' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      coursename,coursecode,co,level,minvalue,maxvalue,status <br /><br />
