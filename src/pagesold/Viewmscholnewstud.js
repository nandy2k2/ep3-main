...
import AddUserModal from './Addmscholnewstud';
import AddUserModalBulk from './Addmscholnewbulkstud';
...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/getscholnewstudbyfac', {
        params: {
          token: token,
          colid: colid,
          user: user,
    ...
    const getgraphdata = async () => {
      const response = await ep1.get('/api/v2/getscholnewcountbystud', {
        params: {
          token: token,
          colid: colid,
          user: user,
    ...
    const getgraphdatasecond = async () => {
      const response = await ep1.get('/api/v2/getscholnewsecondbystud', {
        params: {
          token: token,
          colid: colid,
          user: user,
