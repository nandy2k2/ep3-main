...
return;
 ...
 const lmscoursecode=global1.faccoursecode;


  const searchapi = async (rownumber,year,coursecode,title,description,starttime,endtime,duration,weightage,type,level,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,coursecode,title,description,starttime,endtime,duration,weightage,type,level,status <br /><br />
