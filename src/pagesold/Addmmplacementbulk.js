...
return;
  ...
  const searchapi = async (rownumber,year,student,regno,phone,email,program,programcode,employer,empaddress,empcontact,salary,type,doclink,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,student,regno,phone,email,program,programcode,employer,empaddress,empcontact,salary,type,doclink,status <br /><br />
