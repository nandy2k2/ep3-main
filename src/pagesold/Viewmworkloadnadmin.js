...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/workloadndocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getworkloadncount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getworkloadnsecond', {
          params: {
            token: token,
            colid: colid,
            user: user
