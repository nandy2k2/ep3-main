...
const clubtype=clubtyperef.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createnn6clubsbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      <p>{transcript}</p>
       ...
       <button onClick={setclub}>Set Hackathon or Ideathon name</button>
...
<p>Hackathon or Ideathon name</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={clubref} /><br /><br />

<InputLabel id="clubtype">Club type</InputLabel><Select labelId="clubtype"
id="clubtype"
inputRef={clubtyperef}
sx={{ width: '100%'}}
>
<MenuItem value="Cultural Club">Cultural Club</MenuItem>
<MenuItem value="Mental Health Club">Mental Health Club</MenuItem>
<MenuItem value="Sports Club">Sports Club</MenuItem>
<MenuItem value="Community Activities through UBA">Community Activities through UBA</MenuItem>
</Select>
<br /><br />
