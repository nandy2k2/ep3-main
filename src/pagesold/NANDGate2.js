            ...
            <Box className={styles.instrauctionwrapper}>
              ...
              <ol>
                ...
                <li>Click on "<span
                  ...
                  >
                    Check
                  </span>"{" "} Button to verify your output.</li>
                <li>
                  Click "<span
                    style={{
                      textDecoration: "underline",
                  ...
                  >
                    Print
                  </span>"{" "} if you want to get print out of Truth Table.
                </li>
              </ol>
            </Box>
          </Box>
          <Box className={styles.cardWrapperFirstNANDGate}>
            <Box className={styles.titleNandGate}>
              <marquee>
                <h3>Verification of truth table for NAND gate</h3>
              </marquee>
            </Box>
            {/* Displaying the image based on button states */}
            <img
              src="https://jadavpuruniversity.s3-ap-south-1.amazonaws.com/8-2024-28-3756-nand-gate-part-2.png"
            ...
            <TextField
              ...
              label="Input A"
              variant="outlined"
              sx={{ position: "absolute", zIndex: 2, top: "16%", left: "13%" }}
              value={inputAVal}
              onChange={(e) =>
            ...
            <TextField
              ...
              label="Output"
              variant="outlined"
              sx={{ position: "absolute", zIndex: 2, top: "22%", right: "3%" }}
              value={outputVal}
              onChange={(e) =>
