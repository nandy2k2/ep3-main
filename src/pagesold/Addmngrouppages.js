...
const setpagelink=(id)=> {
if(transcript) {
pagelinkref.current.value=transcript;
 }
 }
...
const pagelink=pagelinkref.current.value;
...
status1:'Submitted',
 ...
 <button onClick={setpagelink}>Set Page link</button>
...
<p>Page link</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={pagelinkref} /><br /><br />
