...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/examtimetabledocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getexamtimetablecount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getexamtimetablesecond', {
          params: {
            token: token,
            colid: colid,
            user: user
