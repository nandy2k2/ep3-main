...
const benefits = [
  'Promotes environmental awareness among students and staff.',
  'Encourages sustainable practices like energy and water conservation.',
  'Identifies gaps in current environmental practices and policies.',
  'Helps institutions comply with national green campus initiatives.',
  'Boosts NAAC accreditation through evidence of sustainability efforts.',
];

const steps = [
  'Form a Green Audit Committee including staff, students, and external experts.',
  'Define audit scope (energy, water, waste, biodiversity, etc.).',
  'Develop audit tools such as checklists, survey forms, and templates.',
  'Conduct physical inspection, collect data, and document observations.',
  'Analyze data to identify gaps and opportunities.',
  'Submit report with findings, recommendations, and action plan.',
  'Implement suggestions and monitor improvements regularly.',
];
...
function CampusWebsite(props) {
 ...
 <Typography variant="h4" gutterBottom>
           ...
           <Typography variant="body1" paragraph>
            A Green Audit is a systematic examination of an educational institution’s environmental practices and sustainability performance. It aims to assess how effectively the institution is managing its resources such as energy, water, and waste, while promoting eco-friendly policies and practices.
          </Typography>
          <Typography variant="body1" paragraph>
            In the context of Indian educational institutions, Green Audits are often aligned with national initiatives such as Swachh Bharat, Unnat Bharat Abhiyan, and NAAC’s quality benchmarks. They encourage students and faculty to adopt sustainable habits and help institutions demonstrate their commitment to environmental responsibility.
          </Typography>
          <Typography variant="body1">
            The audit process typically includes inspection of infrastructure, evaluation of environmental impact, policy analysis, and implementation of green initiatives such as solar panels, rainwater harvesting, and paperless administration.
          </Typography>
          <br /><br />
      ...
      <Card elevation={3}>
        <CardContent>
          <Typography variant="h5" gutterBottom>
            📋 Steps to Conduct a Green Audit
          </Typography>
          <List>
