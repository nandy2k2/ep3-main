...
const appearedref=useRef();
const passedref=useRef();
const passpref=useRef();
...
const appeared=appearedref.current.value;
const passed=passedref.current.value;
const passp=passpref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createnn53passpbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
<p>No of appeared</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={appearedref} /><br /><br />

<p>No of passed</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={passedref} /><br /><br />

<p>Pass percentage</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={passpref} /><br /><br />
