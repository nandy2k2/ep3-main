...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/wspill1docs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getwspill1count', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getwspill1second', {
          params: {
            token: token,
            colid: colid,
            user: user
