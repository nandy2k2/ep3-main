...
return;
  ...
  const searchapi = async (rownumber,patient,phone,contact,illness,treatment,surgery,amount,mdate,followupdate,doctorref,doctor,assignedto,leadstatus,status1) => {
...
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Contact' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Treatment' + ',';
return;
}
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Surgery' + ',';
return;
}
...
f1=f1 + 'row ' + rownumber + '-' + 'Meeting date' + ',';
return;
}
...
if(!row[9]){
f1=f1 + 'row ' + rownumber + '-' + 'Doctor reference' + ',';
return;
}
if(!row[10]){
f1=f1 + 'row ' + rownumber + '-' + 'Doctor' + ',';
return;
}
if(!row[11]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      patient,phone,contact,illness,treatment,surgery,amount,mdate,followupdate,doctorref,doctor,assignedto,leadstatus,status <br /><br />
