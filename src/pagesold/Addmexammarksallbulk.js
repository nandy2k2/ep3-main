...
return;
  ...
  const searchapi = async (rownumber,exam,examcode,academicyear,student,regno,program,programcode,course,coursecode,iafull,iamarks,eafull,eamarks,totalfull,totalmarks,totalp,egrade,semester,status1) => {
...
if(!row[7]){
f1=f1 + 'row ' + rownumber + '-' + 'Course' + ',';
return;
}
if(!row[8]){
f1=f1 + 'row ' + rownumber + '-' + 'Couse code' + ',';
return;
}
if(!row[9] || isNaN(row[9])){
f1=f1 + 'row ' + rownumber + '-' + 'IA1 Full Marks' + ',';
return;
}
if(!row[10] || isNaN(row[10])){
f1=f1 + 'row ' + rownumber + '-' + 'IA1 Marks obtained' + ',';
return;
}
if(!row[11] || isNaN(row[11])){
f1=f1 + 'row ' + rownumber + '-' + 'External full marks' + ',';
return;
}
if(!row[12] || isNaN(row[12])){
f1=f1 + 'row ' + rownumber + '-' + 'External marks obtained' + ',';
return;
}
if(!row[13] || isNaN(row[13])){
f1=f1 + 'row ' + rownumber + '-' + 'Total full marks' + ',';
return;
}
if(!row[14] || isNaN(row[14])){
f1=f1 + 'row ' + rownumber + '-' + 'Total marks obtained' + ',';
return;
}
if(!row[15] || isNaN(row[15])){
f1=f1 + 'row ' + rownumber + '-' + 'Percentage' + ',';
return;
}
if(!row[16]){
...
return;
            ...
            searchapi(rownumber,row[0],row[1],row[2],row[3],row[4],row[5],row[6],row[7],row[8],row[9],row[10],row[11],row[12],row[13],row[14],row[15],row[16],row[17],status1);
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      exam,examcode,academicyear,student,regno,program,programcode,course,coursecode,iafull,iamarks,eafull,eamarks,totalfull,totalmarks,totalp,egrade,semester,status <br /><br />
