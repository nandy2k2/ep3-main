...
return;
  ...
  const searchapi = async (rownumber,year,facility,Faccode,mlocation,doclink,type,level,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Facility' + ',';
return;
}
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Facility code' + ',';
return;
}
if(!row[3]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,facility,Faccode,mlocation,doclink,type,level,status <br /><br />
