...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/pallergiesdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getpallergiescount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getpallergiessecond', {
          params: {
            token: token,
            colid: colid,
            user: user
