...
return;
  ...
  const searchapi = async (rownumber,year,assetid,asset,username,assigndate,returndate,assetstatus,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Asset id' + ',';
return;
}
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Asset' + ',';
return;
}
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Assigned to username' + ',';
return;
}
...
f1=f1 + 'row ' + rownumber + '-' + 'Returndate' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Asset status' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,assetid,asset,username,assigndate,returndate,assetstatus,status <br /><br />
