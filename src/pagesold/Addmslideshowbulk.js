...
return;
  ...
  const searchapi = async (rownumber,moduleid,description,imagelink,type,slideno,ctype,duration,status1) => {
...
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Class type' + ',';
return;
}
if(!row[6] || isNaN(row[6])){
f1=f1 + 'row ' + rownumber + '-' + 'Duration in secs' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      moduleid,description,imagelink,type,slideno,ctype,duration,status <br /><br />
