...
return;
  ...
  const searchapi = async (rownumber,patient,puser,admid,pdate,discussion,ptime,doccomments,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Patient ID' + ',';
return;
}
if(!row[2]){
...
f1=f1 + 'row ' + rownumber + '-' + 'Counseling date' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Discussion' + ',';
return;
}
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Discussion time' + ',';
return;
}
if(!row[6]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      patient,puser,admid,pdate,discussion,ptime,doccomments,status <br /><br />
