...
const Signup = () => {
  ...
  diff /= (60 * 60 * 24);
            ...
            global1.bulkuploadurl='https://ctserver1.azurewebsites.net/';
      ...
      >
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  <Typography variant="body1" align="center" color='black' sx={{ mt: 2, mb: 1 }}>
                    Don't have an account? Contact institution or team@epaathsala.com.
                  </Typography>
                  {/* <Typography variant="body1" align="center" color='black' sx={{ mt: 2, mb: 1 }}>
        ...
        <Box sx={{ 
          ...
          <Typography variant='h2' fontWeight="bold" fontSize={{ xs: '1.5rem', sm: '2.5rem', md: '3rem' }} textTransform="uppercase" display={{xs:"none",md:"block"}}>
            Post job and manage applications
          </Typography>
        </Box>
      </Box>
    </Box>
