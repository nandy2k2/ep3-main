...
import AddUserModal from './Addmnn55';
import AddUserModalBulk from './Addmnn55bulk';
  ...
  const handleImageUpload = (event) => {
    ...
    const handleDeleteClick = async (id) => {
      ...
      const onButtonClick = async(e, row) => {
        ...
        //alert(row._id);
        const response = await ep1.get('/api/v2/deletenn55byfac', {
            params: {
                id: row._id,
                token: token,
                user: user
...
{
field:'slow',
headerName:'No of slow learners',
type:'number',
width:200,
editable:true,
valueFormatter: (params) => {
...
{
field:'advanced',
headerName:'No of advanced learners',
type:'number',
width:200,
editable:true,
valueFormatter: (params) => {
...
{
field:'diverse',
headerName:'No fo students with diverse need',
type:'number',
width:200,
editable:true,
valueFormatter: (params) => {
...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/getnn55byfac', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
      const response = await ep1.get('/api/v2/getnn55countbyfac', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdatasecond = async () => {
      const response = await ep1.get('/api/v2/getnn55secondbyfac', {
        params: {
          token: token,
          colid: colid,
          user: user
...
const advanced=user.advanced;
const diverse=user.diverse;
...
const level=user.level;
            ...
            const response =await ep1.get('/api/v2/updatenn55byfac', {
            params: {
            id: user._id,
            user: user.user,
            token:token,
