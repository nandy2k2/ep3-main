...
return '';
          ...
          { field: 'actions', headerName: 'Actions', width: 600, renderCell: (params) => {
            return (
              <TextToSpeech text={params.row.voicetext} /> 
              // <Button
...
mode:mode,
    ...
    const onButtonClicky = async(e, description) => {
      e.stopPropagation();


      window.open('https://www.youtube.com/results?search_query=' + description);
...
{rows.map((meetup3) => {
                return (
                  <div>
                    ...
                    Module {meetup3.slideno}<br /><br />
                    Title: {meetup3.title}<br /><br />
                    Description: <br /><br />
                    ...
                    {/* Image link <a href={meetup3.imagelink} target="_blank">{meetup3.imagelink}</a><br /> */}
                     {meetup3.imagelink.indexOf('http')>-1 ? (
       <img src={meetup3.imagelink} />
      ) : (
        <span></span>
      )}
                    {/* <img src={meetup3.imagelink} /> */}
                    <br /><br />
                      <Button
                                    onClick={(e) => onButtonClicky(e, meetup3.description)}
                                    variant="contained"
                                    sx={{ backgroundColor: '#440404ff', color: '#ffffff', padding: '5px 10px', fontSize: '12px', height: '30px', width: '250px'}}
                                  >
                    ...
                    Document Link: &nbsp;
                    {meetup3.doclink.indexOf('http')>-1 ? (
        <a href={meetup3.doclink} target="_blank" rel="noopener noreferrer">
          {/* {meetup3.doclink} */}
