        ...
        <Grid item xs={12}>
          ...
          <Box className={styles.cardWrapperFirstANDGate}>
            ...
            <TextField
              ...
              label="Input A"
              variant="outlined"
              sx={{ position: "absolute", zIndex: 2, top: "17.5%", left: "2%" }}
              value={inputAVal}
              onChange={(e) =>
            ...
            <TextField
              ...
              label="Input B"
              variant="outlined"
              sx={{ position: "absolute", zIndex: 2, top: "28.8%", left: "2%" }}
              value={inputBVal}
              onChange={(e) =>
            ...
            <TextField
              ...
              label="Output"
              variant="outlined"
              sx={{ position: "absolute", zIndex: 2, top: "23%", right: "22%" }}
              value={outputVal}
              onChange={(e) =>
