...
const lessonnoref=useRef();
const lessonref=useRef();
const lessonplanref=useRef();
const noofperiodref=useRef();
...
const setlesson=(id)=> {
if(transcript) {
lessonref.current.value=transcript;
 }
 }
const setlessonplan=(id)=> {
if(transcript) {
lessonplanref.current.value=transcript;
 }
 }
const settopics=(id)=> {
if(transcript) {
topicsref.current.value=transcript;
 }
 }
...
const lessonno=lessonnoref.current.value;
const lesson=lessonref.current.value;
const lessonplan=lessonplanref.current.value;
const noofperiod=noofperiodref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createlessonplannewbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
status1:'Submitted',
 ...
 <button onClick={setcourse}>Set Course ID</button>
 ...
 <button onClick={setlesson}>Set Lesson name</button>
 <button onClick={setlessonplan}>Set Lesson Plan</button>
 <button onClick={settopics}>Set Topics covered</button>
...
<p>Lesson no</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={lessonnoref} /><br /><br />

<p>Lesson name</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={lessonref} /><br /><br />

<p>Lesson Plan</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={lessonplanref} /><br /><br />

<p>No of period</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={noofperiodref} /><br /><br />
...
<LocalizationProvider dateAdapter={AdapterDayjs}><DatePicker label="Actual date" inputRef={actualdateref} sx={{ width: "100%"}} /></LocalizationProvider><br /><br />

<p>Topics covered</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={topicsref} /><br /><br />
