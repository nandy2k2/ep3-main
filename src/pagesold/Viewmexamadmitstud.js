...
import AddUserModal from './Addmexamadmitstud';
import AddUserModalBulk from './Addmexamadmitbulkstud';
...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/getexamadmitstudbyfac', {
        params: {
          token: token,
          colid: colid,
          user: user,
    ...
    const getgraphdata = async () => {
      const response = await ep1.get('/api/v2/getexamadmitcountbystud', {
        params: {
          token: token,
          colid: colid,
          user: user,
    ...
    const getgraphdatasecond = async () => {
      const response = await ep1.get('/api/v2/getexamadmitsecondbystud', {
        params: {
          token: token,
          colid: colid,
          user: user,
