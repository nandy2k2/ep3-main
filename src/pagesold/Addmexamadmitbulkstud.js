...
return;
  ...
  const searchapi = async (rownumber,year,exam,examcode,program,programcode,course,coursecode,semester,student,regno,enabled,type,level,status1) => {
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createexamadmitstudbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,exam,examcode,program,programcode,course,coursecode,semester,student,regno,enabled,type,level,status <br /><br />
