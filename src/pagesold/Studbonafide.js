      ...
      <Paper elevation={3} sx={{ padding: 4,
        ...
        {/* <Grid container spacing={2}>
          ...
          <Typography variant="body1" gutterBottom>
            ...
            is a bonafide student of <strong>{insname}</strong>.
          </Typography>
          <Typography variant="body1" gutterBottom>
            He/She is studying in class <strong>{global1.programcode}</strong> and his registration no. is  <strong>{regno}</strong>.
          </Typography>
        </Box>
