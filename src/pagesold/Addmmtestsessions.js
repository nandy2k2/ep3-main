...
const setsession=(id)=> {
if(transcript) {
sessionref.current.value=transcript;
 }
 }
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createmtestsessionsbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      <DialogContent>
        ...
        Time Zone is in UK time zone. Please select time accordingly. <br /><br />
...
<p>Session</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={sessionref} /><br /><br />

{/* <p>Start time</p>
<TextField id="outlined-basic"  type="Date" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={starttimeref} /><br /><br />

<p>End time</p>
<TextField id="outlined-basic"  type="Date" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={endtimeref} /><br /><br /> */}
