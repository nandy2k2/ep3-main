...
return;
  ...
  const searchapi = async (rownumber,year,jobid,jobtitle,companyname,companyemail,studentname,studentemail,studentregno,studentcv,status,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Job id' + ',';
return;
}
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Job title' + ',';
return;
}
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Company name' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Company email' + ',';
return;
}
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Student name' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Student email' + ',';
return;
}
if(!row[7]){
f1=f1 + 'row ' + rownumber + '-' + 'Student reg no' + ',';
return;
}
if(!row[8]){
f1=f1 + 'row ' + rownumber + '-' + 'Student cv id' + ',';
return;
}
if(!row[9]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,jobid,jobtitle,companyname,companyemail,studentname,studentemail,studentregno,studentcv,status,status <br /><br />
