...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/timeslotsn1docs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/gettimeslotsn1count', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/gettimeslotsn1second', {
          params: {
            token: token,
            colid: colid,
            user: user
