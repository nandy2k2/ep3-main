...
return;
  ...
  const searchapi = async (rownumber,loation,type,binid,spilldetails,spilldate,spilltime,actiontaken,status,status1) => {
...
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Action taken' + ',';
return;
}
if(!row[7]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      loation,type,binid,spilldetails,spilldate,spilltime,actiontaken,status,status <br /><br />
