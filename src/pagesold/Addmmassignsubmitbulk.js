...
return;
  ...
  const searchapi = async (rownumber,year,course,coursecode,assignment,assignmentid,student,regno,description,submitdate,doclink,ascomments,status1) => {
...
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Assignment' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Assignment id' + ',';
return;
}
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Student' + ',';
...
f1=f1 + 'row ' + rownumber + '-' + 'Submission date' + ',';
return;
}
if(!row[9]){
...
if(!row[10]){
f1=f1 + 'row ' + rownumber + '-' + 'Assignment comments' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,course,coursecode,assignment,assignmentid,student,regno,description,submitdate,doclink,ascomments,status <br /><br />
