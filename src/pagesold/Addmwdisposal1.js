...
const collectiondate=collectiondateref.current.value;
...
<p>Collection date</p>
<TextField id="outlined-basic"  type="Date" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={collectiondateref} /><br /><br />
