...
const slow=slowref.current.value;
const advanced=advancedref.current.value;
const diverse=diverseref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createnn55byfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
<p>No of slow learners</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={slowref} /><br /><br />

<p>No of advanced learners</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={advancedref} /><br /><br />

<p>No fo students with diverse need</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={diverseref} /><br /><br />
...
<MenuItem value="Not changed">Not changed</MenuItem>
</Select>
<br /><br />
