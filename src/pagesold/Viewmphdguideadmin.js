...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/phdguidedocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getphdguidecount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getphdguidesecond', {
          params: {
            token: token,
            colid: colid,
            user: user
