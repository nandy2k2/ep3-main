...
if(transcript) {
participantsref.current.value=transcript;
 }
 }
...
const setagenda=(id)=> {
if(transcript) {
agendaref.current.value=transcript;
 }
 }
...
const year=yearref.current.value;
const quarter=quarterref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createnn76byfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      <p>{transcript}</p>
       ...
       <button onClick={setparticipants}>Set Participants</button>
 <button onClick={setactivity}>Set Activity date</button>
 <button onClick={setagenda}>Set Agenda</button>
...
<InputLabel id="quarter">Quarter</InputLabel><Select labelId="quarter"
id="quarter"
inputRef={quarterref}
sx={{ width: '100%'}}
>
...
<p>Participants</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={participantsref} /><br /><br />

<p>Activity date</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={activityref} /><br /><br />

<LocalizationProvider dateAdapter={AdapterDayjs}><DatePicker label="Meeting date" inputRef={actdateref} sx={{ width: "100%"}} /></LocalizationProvider><br /><br />

<p>Agenda</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={agendaref} /><br /><br />
...
<MenuItem value="SSR approval">SSR approval</MenuItem>
<MenuItem value="AQAR approval">AQAR approval</MenuItem>
<MenuItem value="Other approval">Other approval</MenuItem>
</Select>
<br /><br />
