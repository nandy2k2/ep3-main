...
const lms=lmsref.current.value;
...
<InputLabel id="lms">Is LMS</InputLabel><Select labelId="lms"
id="lms"
inputRef={lmsref}
sx={{ width: '100%'}}
>
...
<p>No of students using</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={studentsref} /><br /><br />

<p>No of faculties using</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={facultyref} /><br /><br />
