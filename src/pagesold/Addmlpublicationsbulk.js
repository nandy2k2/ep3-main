...
return;
  ...
  const searchapi = async (rownumber,year,institution,publication,issn,editor,frequency,publisher,type,status1) => {
...
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'ISSN number' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Editor' + ',';
return;
}
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Frequency' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Publisher' + ',';
return;
}
if(!row[7]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,institution,publication,issn,editor,frequency,publisher,type,status <br /><br />
