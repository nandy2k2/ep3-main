...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/mvendorsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getmvendorscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getmvendorssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
