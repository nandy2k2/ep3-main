...
const allowance=allowanceref.current.value;
...
<LocalizationProvider dateAdapter={AdapterDayjs}><DatePicker label="Salary date" inputRef={sdateref} sx={{ width: "100%"}} /></LocalizationProvider><br /><br />

<p>Salary</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={salaryref} /><br /><br />

<p>Allowance</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={allowanceref} /><br /><br />
