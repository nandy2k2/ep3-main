...
return;
  ...
  const searchapi = async (rownumber,year,course,coursecode,title,eventdate,type,location,duration,monthofyea,status1) => {
...
if(!row[8]){
f1=f1 + 'row ' + rownumber + '-' + 'Month of year' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,course,coursecode,title,eventdate,type,location,duration,monthofyea,status <br /><br />
