...
import styles from "../virtuallabcss/XORGateGame.module.css";
import {
  Box,
  Button,
  Container,
...
function XORGate() {
  ...
  const checkOutputCorrectOrNot = (inputA, inputB, output) => {
    const expectedOutput =
      (inputA === 0 || inputB === 1) && (inputA === 1 || inputB === 0) ? 0 : 1;
    ...
    <Box p="20px 0px">
        ...
        <Box>
          ...
          >
            ...
            >
              ...
              >
                Verification and interpretation of truth table for <br /> XOR
                gate / XOR gate 2
              </Typography>
            </Box>
            <Button
          ...
          <Grid container spacing={2} direction="column" alignItems="center">
            <Grid item xs={12}>
              ...
              <Box className={styles.cardWrapperFirstXORGate}>
                <Box className={styles.titleXORGate}>
                  <marquee>
                    <h3>Verification of truth table for XOR gate</h3>
                  </marquee>
                </Box>
                {/* Displaying the image based on button states */}
                <img
                  src="https://jadavpuruniversity.s3-ap-south-1.amazonaws.com/9-2024-2-1719-xor-gate-part2.png"
      ...
      {level > 2 && (
        ...
        >
          ...
          >
            Verification and interpretation of truth table for XOR gate / XOR
            gate2
          </Typography>
          <Box
            sx={{
