...
import styles from "../virtuallabcss/ORGateGame.module.css";
    ...
    <Box p="20px 0px">
        ...
        <Box>
          ...
          >
            ...
            >
              ...
              >
                Verification and interpretation of truth table for <br /> OR
                gate / OR gate 2
              </Typography>
            </Box>
            <Button
            ...
            <Grid item xs={12}>
              ...
              <Box className={styles.cardWrapperFirstORGate}>
                <Box className={styles.titleOrGate}>
                  <marquee>
                    <h3>
                      Experiment to perform OR gate on kit. OR logic
                      implementation using DRL(Diode Resistance Logic).
                    </h3>
                  </marquee>
                </Box>
        ...
        <>
          ...
          <Grid container spacing={2} direction="column" alignItems="center">
            <Grid item xs={12}>
              ...
              <Box className={styles.cardWrapperFirstORGate} sx={{padding: "10px"}}>
                <Box className={styles.instrauctionwrapper}>
                  <h3 style={{color:"#FF0000"}}>INSTRUCTIONS:</h3>
                  <ol style={{marginLeft: "20px", marginTop: "10px"}}>
      ...
      {level > 2 && (
        ...
        >
          ...
          >
            Verification and interpretation of truth table for OR gate / OR
            gate2
          </Typography>
          <Box
            sx={{
