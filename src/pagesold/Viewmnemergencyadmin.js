...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/nemergencydocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getnemergencycount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getnemergencysecond', {
          params: {
            token: token,
            colid: colid,
            user: user
