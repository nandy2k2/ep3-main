...
const setativity=(id)=> {
if(transcript) {
ativityref.current.value=transcript;
 }
 }
...
const ativity=ativityref.current.value;
...
status1:'Submitted',
 ...
 <button onClick={setativity}>Set Activity</button>
...
<p>Activity</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={ativityref} /><br /><br />
