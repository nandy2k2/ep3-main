...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/mpurchaseitemsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getmpurchaseitemscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getmpurchaseitemssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
