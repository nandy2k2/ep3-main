...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createnn36byfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
status1:'Submitted',
 ...
 <button onClick={setagency}>Set Agency with MoU</button>
...
sx={{ width: '100%'}}
>
<MenuItem value="Innovation center">Innovation center</MenuItem>
<MenuItem value="Incubation Center">Incubation Center</MenuItem>
<MenuItem value="Fabrication lab">Fabrication lab</MenuItem>
<MenuItem value="EDC Cell">EDC Cell</MenuItem>
<MenuItem value="Software Lab">Software Lab</MenuItem>
<MenuItem value="Seed Grant Network">Seed Grant Network</MenuItem>
<MenuItem value="Mentorship Network">Mentorship Network</MenuItem>
<MenuItem value="Industry Linkage">Industry Linkage</MenuItem>
</Select>
<br /><br />
