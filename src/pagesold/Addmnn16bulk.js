...
return;
  ...
  const searchapi = async (rownumber,program,programcode,year,mooc,guestl,onlinec,offlinec,type,level,status1) => {
...
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'MOOC courses' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Guest lectures' + ',';
return;
}
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Online courses' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Offline courses' + ',';
return;
}
if(!row[7]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      program,programcode,year,mooc,guestl,onlinec,offlinec,type,level,status <br /><br />
