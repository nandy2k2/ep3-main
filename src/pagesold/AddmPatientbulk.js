...
return;
  ...
  const searchapi = async (rownumber,mrnumber,patient,age,gender,phone,email,address,bloodGroup,username,password,dob,status1) => {
...
if(!row[7]){
f1=f1 + 'row ' + rownumber + '-' + 'Blood group' + ',';
return;
}
if(!row[8]){
...
return;
 ...
 if(isNaN(new Date(row[10]))) {
f1=f1 + 'row ' + rownumber + '-' + 'date of birth' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      mrnumber,patient,age,gender,phone,email,address,bloodGroup,username,password,dob,status <br /><br />
