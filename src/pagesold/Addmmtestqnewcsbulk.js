...
return;
  ...
  const searchapi = async (rownumber,testid,sectionid,question,questionimg,questionlink,optiona,optionb,optionc,optiond,correcta,type,level,status1) => {
...
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Image link' + ',';
return;
}
if(!row[4]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      testid,sectionid,question,questionimg,questionlink,optiona,optionb,optionc,optiond,correcta,type,level,status <br /><br />
