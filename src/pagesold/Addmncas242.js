...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v1/createncas242byfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
<InputLabel id="type">Type of Research Projects Completed</InputLabel><Select labelId="type"
id="type"
inputRef={typeref}
sx={{ width: '100%'}}
>
<MenuItem value="More than 10 lakhs">More than 10 lakhs</MenuItem>
<MenuItem value="Less than 10 lakhs">Less than 10 lakhs</MenuItem>
</Select>
<br /><br />
