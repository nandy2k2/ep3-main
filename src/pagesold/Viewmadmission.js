...
function ViewPage() {
    ...
    const link1="https://campustechnology.me/admissionform1/" + colid;
    const link2="https://campustechnology.me/admissionform2/" + colid;
    const link3="https://campustechnology.me/admissionform3/" + colid;
    const link4="https://campustechnology.me/admissionform4/" + colid;
    ...
    const onButtonClickm = async() => {
      ...
      const response = await epai1.get('/api/v1/getresponse2', {
          params: {
              user:user,
              colid:colid,
              prompt:'Create a detailed answer for ' + policy + ' with focus on ' + keywords + ' with a list of supporting documents'
          }
      ...
      >
        <CircularProgress color="inherit" />
            ...
            <Grid item xs={12}>
             ...
             <a href={link1} target="blank">Admission form template 1</a>
<br />
 <a href={link2} target="blank">Admission form template 2</a>
<br />
 <a href={link3} target="blank">Admission form template 3</a>
<br />
 <a href={link4} target="blank">Admission form template 4</a>
<br />
