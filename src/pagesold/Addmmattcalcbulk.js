...
return;
  ...
  const searchapi = async (rownumber,year,coursename,coursecode,faculty,co,component,marksp,weightage,percentage,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Course name' + ',';
return;
}
if(!row[2]){
...
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Course outcome' + ',';
return;
}
if(!row[5]){
...
f1=f1 + 'row ' + rownumber + '-' + 'Marks percentage' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,coursename,coursecode,faculty,co,component,marksp,weightage,percentage,status <br /><br />
