...
const setslotstatus=(id)=> {
if(transcript) {
slotstatusref.current.value=transcript;
 }
 }
const setroom=(id)=> {
if(transcript) {
...
status1:'Submitted',
 ...
 <button onClick={setfaculty}>Set Fa</button>
 <button onClick={setfacultyid}>Set undefined</button>
 <button onClick={setcourse}>Set undefined</button>
 <button onClick={setslotstatus}>Set undefined</button>
 <button onClick={setroom}>Set undefined</button>
 <button onClick={settype}>Set undefined</button>
 <button onClick={setlevel}>Set undefined</button>
...
<p>undefined</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={slotstatusref} /><br /><br />
