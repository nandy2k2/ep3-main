  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      <p>{transcript}</p>
       ...
       <button onClick={setprogram}>Set undefined</button>
 <button onClick={setsemester}>Set undefined</button>
 <button onClick={setsection}>Set undefined</button>
 <button onClick={setfaculty}>Set undefined</button>
