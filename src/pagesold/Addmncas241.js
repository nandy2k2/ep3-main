...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v1/createncas241byfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
<InputLabel id="type">Type of Research guidance</InputLabel><Select labelId="type"
id="type"
inputRef={typeref}
sx={{ width: '100%'}}
>
<MenuItem value="Ph.D.">Ph.D.</MenuItem>
<MenuItem value="M.Phil. or P.G dissertation">M.Phil. or P.G dissertation</MenuItem>
</Select>
<br /><br />
