...
return;
  ...
  const searchapi = async (rownumber,year,event,department,startdate,description,brochurelink,reportlink,coordinator,type,level,collab,moulink,participants,duration,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Event' + ',';
return;
}
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Department' + ',';
return;
}
 if(isNaN(new Date(row[3]))) {
f1=f1 + 'row ' + rownumber + '-' + 'Start date' + ',';
return;
}
if(!row[4]){
...
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Brochure link' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Report link' + ',';
return;
}
if(!row[7]){
f1=f1 + 'row ' + rownumber + '-' + 'Coordinator' + ',';
return;
}
if(!row[8]){
...
if(!row[10]){
f1=f1 + 'row ' + rownumber + '-' + 'Collaborating agency' + ',';
return;
}
if(!row[11]){
f1=f1 + 'row ' + rownumber + '-' + 'MoU link' + ',';
return;
}
if(!row[12] || isNaN(row[12])){
f1=f1 + 'row ' + rownumber + '-' + 'No of participants' + ',';
return;
}
if(!row[13] || isNaN(row[13])){
f1=f1 + 'row ' + rownumber + '-' + 'Duration in days' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,event,department,startdate,description,brochurelink,reportlink,coordinator,type,level,collab,moulink,participants,duration,status <br /><br />
