...
return;
  ...
  const searchapi = async (rownumber,videoid,coursecode,video,title,image,voicetext,duration,type,language,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      videoid,coursecode,video,title,image,voicetext,duration,type,language,status <br /><br />
