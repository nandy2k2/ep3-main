...
return;
  ...
  const searchapi = async (rownumber,patient,puser,admid,lab,test,finding,result,testdate,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      patient,puser,admid,lab,test,finding,result,testdate,status <br /><br />
