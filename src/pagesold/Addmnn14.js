...
const studprojref=useRef();
const studinternref=useRef();
...
const year=yearref.current.value;
const projects=projectsref.current.value;
const internship=internshipref.current.value;
const studproj=studprojref.current.value;
const studintern=studinternref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createnn14byfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
<InputLabel id="projects">Projects</InputLabel><Select labelId="projects"
id="projects"
...
<InputLabel id="internship">Internship</InputLabel><Select labelId="internship"
id="internship"
inputRef={internshipref}
sx={{ width: '100%'}}
>
<MenuItem value="Yes">Yes</MenuItem>
<MenuItem value="No">No</MenuItem>
...
<p>No of students participating in projects</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={studprojref} /><br /><br />

<p>No of students in internship</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={studinternref} /><br /><br />
