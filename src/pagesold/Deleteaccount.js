...
const Signup = () => {
    ...
    const username=email;
        ...
        emailbody=emailbody + 'We are sorry to see you request deleting your account. Your account will be deleted within 1 business day.<br /><br />';
        emailbody=emailbody + 'Please send us an email at team@epaathsala.com with details of what went wrong so that we could improve our services.<br /><br />';
        emailbody = emailbody + 'Let us know if there is anything we can do to make things working.<br /><br />';
        emailbody=emailbody + 'Regards,<br /><br />Team epaathsala';
        
        const response = await ep1.get('/api/v2/sendawsemail', {
            params: {
                email: username,
                emailbody: emailbody,
        ...
        alert('Confirmation is sent in your email.')
