...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/teacherfellowdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getteacherfellowcount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getteacherfellowsecond', {
          params: {
            token: token,
            colid: colid,
            user: user
