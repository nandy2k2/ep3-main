...
return;
  ...
  const searchapi = async (rownumber,year,examcode,examdate,examslot,program,programcode,course,coursecode,type,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,examcode,examdate,examslot,program,programcode,course,coursecode,semester,status <br /><br />
                        Do not add any extra column or rows. Date must be in mm/dd/yyyy format. Value of status must always be Submitted.
                        <br /><br />
                        Semester must be First, Second, Third etc.
            <br />
