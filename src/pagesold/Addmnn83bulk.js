...
return;
  ...
  const searchapi = async (rownumber,year,program,programcode,student,regno,company,sector,contact,doclink,type,level,status1) => {
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createnn83byfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,program,programcode,student,regno,company,sector,contact,doclink,type,level,status <br /><br />
