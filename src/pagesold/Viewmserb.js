...
function ViewPage() {
    ...
    const onButtonClickm = async(type) => {
      //e.stopPropagation();
      ...
      if(!keywords || !policy) {
        alert('Please enter Keywords and Project details');
        return;
      }
      setOpen(true);
    ...
    //   const qno=global1.qno;
      ...
      var prompt='';
      if(type=='origin') {
        prompt='Create Origin of the proposal for ' + policy + ' with focus on ' + keywords + ' for SERB Project proposal for Origin of Proposal.'
      } else if(type=='international') {
        prompt='Create Review of International status of Research and Development for ' + policy + ' with focus on ' + keywords + ' for SERB Project proposal with specific details of projects and studies for Status of Research and Development.'
      } else if(type=='desi') {
        prompt='Create Review of National status of Research and Development for ' + policy + ' with focus on ' + keywords + ' for SERB Project proposal for Status of Research and Development with specific details of projects and studies.'
      }
            ...
            <Grid item xs={12}>
              <Paper elevation={5} sx={{ p: 2, display: 'flex', flexDirection: 'column', width: '100%' }}>
                ...
                <Box>
                    ...
                    <TextField id="outlined-basic" multiline rows={12}   type="text" sx={{ width: "100%"}} label="Project details in few words"  variant="outlined" inputRef={questionref} /><br /><br />

{/* <TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label="Institution name and location"  variant="outlined" inputRef={institutionref} /><br /><br /> */}
...
<br /><br />
<Box display="flex">
    <Button onClick={()=> onButtonClickm('origin')}
             variant="contained"
             color="secondary"
           ...
           <Button onClick={()=> onButtonClickm('international')}
             variant="contained"
             color="secondary"
             style={{  fontSize: '12px', marginTop: '-30px', marginLeft: '10px', height: '40px', width: '300px' }}
           >
             International status
           </Button>
            <Button onClick={()=> onButtonClickm('desi')}
             variant="contained"
             color="secondary"
             style={{  fontSize: '12px', marginTop: '-30px', marginLeft: '10px', height: '40px', width: '300px' }}
           >
