...
return;
  ...
  const searchapi = async (rownumber,year,examcode,seatno,roomno,roomseatno,programcode,coursecode,examdate,student,regno,photo,status1) => {
...
f1=f1 + 'row ' + rownumber + '-' + 'Seat Sl. No.' + ',';
return;
}
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Room no' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Room seat no' + ',';
return;
}
if(!row[5]){
...
if(!row[10]){
f1=f1 + 'row ' + rownumber + '-' + 'Student photo' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,examcode,seatno,roomno,roomseatno,programcode,coursecode,examdate,student,regno,photo,status <br /><br />
