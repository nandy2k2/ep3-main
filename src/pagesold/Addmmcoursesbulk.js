...
return;
  ...
  const searchapi = async (rownumber,year,program,programcode,course,coursecode,type,credit,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,program,programcode,course,coursecode,type,credit,status <br /><br />
