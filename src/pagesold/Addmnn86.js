...
const sanctioned=sanctionedref.current.value;
const admitted=admittedref.current.value;
const applied=appliedref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createnn86byfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
<p>Sanctioned seat</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={sanctionedref} /><br /><br />

<p>Admitted</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={admittedref} /><br /><br />

<p>Applied</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={appliedref} /><br /><br />
...
sx={{ width: '100%'}}
>
<MenuItem value="Complete Admission">Complete Admission</MenuItem>
<MenuItem value="Incomplete Admission">Incomplete Admission</MenuItem>
</Select>
<br /><br />
