...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/emergencydocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getemergencycount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getemergencysecond', {
          params: {
            token: token,
            colid: colid,
            user: user
