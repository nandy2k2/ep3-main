...
return;
  ...
  const searchapi = async (rownumber,year,course,coursecode,assignment,description,duedate,type,methodology,learning,doclink,status1) => {
...
if(!row[7]){
f1=f1 + 'row ' + rownumber + '-' + 'Methodology' + ',';
return;
}
if(!row[8]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,course,coursecode,assignment,description,duedate,type,methodology,learning,doclink,status <br /><br />
