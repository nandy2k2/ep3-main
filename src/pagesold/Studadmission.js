  ...
  return (
    <Container maxWidth="sm" sx={{ mt: 5 }}>
      ...
      <Paper elevation={3} sx={{ padding: 4,
        ...
        <Divider sx={{ my: 2 }} />
          ...
          <Typography variant="body1" gutterBottom>
            This is to certify that <strong>{global1.name}</strong>, 
            has been granted admission to <strong>{insname}</strong>.
          </Typography>
          <Typography variant="body1" gutterBottom>
            He/She would be studying in class <strong>{global1.programcode}</strong> and his/her registration no. is  <strong>{regno}</strong>.
          </Typography>
        </Box>
    

      {/* <Typography variant="body1" gutterBottom>
        This certificate is issued upon the request of the student.
      </Typography> */}
      ...
      <Box mt={6} display="flex" justifyContent="space-between">
        ...
        <Typography variant="body2" align="right">Principal's Signature</Typography>
      </Box>
