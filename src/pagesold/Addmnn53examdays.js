...
const resultdate=resultdateref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createnn53examdaysbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
<LocalizationProvider dateAdapter={AdapterDayjs}><DatePicker label="Last date of exam" inputRef={examdateref} sx={{ width: "100%"}} /></LocalizationProvider><br /><br />

<LocalizationProvider dateAdapter={AdapterDayjs}><DatePicker label="Result date" inputRef={resultdateref} sx={{ width: "100%"}} /></LocalizationProvider><br /><br />

<p>No of days</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={noofdaysref} /><br /><br />
