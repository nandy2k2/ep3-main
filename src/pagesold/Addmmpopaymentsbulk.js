...
return;
  ...
  const searchapi = async (rownumber,year,poid,invoiceid,frombank,amount,invoicedate,paydate,fromaccount,fromifsc,refno,tobank,toaccount,toifsc,paytype,doclink,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'PO ID' + ',';
return;
}
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Invoice ID' + ',';
return;
}
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'From bank' + ',';
return;
}
...
return;
 ...
 if(isNaN(new Date(row[5]))) {
f1=f1 + 'row ' + rownumber + '-' + 'Invoice date' + ',';
return;
}
 if(isNaN(new Date(row[6]))) {
f1=f1 + 'row ' + rownumber + '-' + 'Paydate' + ',';
return;
}
if(!row[7]){
f1=f1 + 'row ' + rownumber + '-' + 'From account' + ',';
return;
}
if(!row[8]){
f1=f1 + 'row ' + rownumber + '-' + 'From IFSC' + ',';
return;
}
if(!row[9]){
f1=f1 + 'row ' + rownumber + '-' + 'Ref no' + ',';
return;
}
if(!row[10]){
f1=f1 + 'row ' + rownumber + '-' + 'To bank' + ',';
return;
}
if(!row[11]){
f1=f1 + 'row ' + rownumber + '-' + 'To account' + ',';
return;
}
if(!row[12]){
f1=f1 + 'row ' + rownumber + '-' + 'To IFSC' + ',';
return;
}
if(!row[13]){
f1=f1 + 'row ' + rownumber + '-' + 'Pay type' + ',';
return;
}
if(!row[14]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,poid,invoiceid,frombank,amount,invoicedate,paydate,fromaccount,fromifsc,refno,tobank,toaccount,toifsc,paytype,doclink,status <br /><br />
