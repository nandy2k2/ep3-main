...
return;
  ...
  const searchapi = async (rownumber,tbl,tfield,type,example,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      tbl,tfield,type,example,status <br /><br />
