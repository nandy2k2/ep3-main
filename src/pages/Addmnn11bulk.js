...
return;
  ...
  const searchapi = async (rownumber,program,programcode,cbcs,cbcsyear,obe,year,type,level,status1) => {
...
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Is CBCS' + ',';
return;
}
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Year of CBCS' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Is OBE' + ',';
return;
}
if(!row[5]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      program,programcode,cbcs,cbcsyear,obe,year,type,level,status <br /><br />
