...
return;
  ...
  const searchapi = async (rownumber,year,sector,companyname,companyemail,title,description,skills,salary,lastapplieddate,joiningdate,status1) => {
...
f1=f1 + 'row ' + rownumber + '-' + 'Skills' + ',';
return;
}
if(!row[7]){
f1=f1 + 'row ' + rownumber + '-' + 'Salary CTC' + ',';
return;
}
 if(isNaN(new Date(row[8]))) {
f1=f1 + 'row ' + rownumber + '-' + 'Last application date' + ',';
return;
}
if(!row[9]){
f1=f1 + 'row ' + rownumber + '-' + 'Tentative joining date' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,sector,companyname,companyemail,title,description,skills,salary,lastapplieddate,joiningdate,status <br /><br />
