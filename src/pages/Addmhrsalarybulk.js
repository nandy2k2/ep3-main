...
return;
  ...
  const searchapi = async (rownumber,year,month,duedate,structure,structureid,employee,empid,component,amount,type,level,status1) => {
...
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Structure' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Structure id' + ',';
return;
}
if(!row[5]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,month,duedate,structure,structureid,employee,empid,component,amount,type,level,status <br /><br />
