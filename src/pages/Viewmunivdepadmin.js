...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/univdepdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getunivdepcount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getunivdepsecond', {
          params: {
            token: token,
            colid: colid,
            user: user
