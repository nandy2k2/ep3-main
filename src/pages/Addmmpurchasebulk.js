...
return;
  ...
  const searchapi = async (rownumber,year,ponumber,podate,description,vendorid,vendor,amount,gst,terms,potype,approval,approvaluser,doclink,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'PO number' + ',';
return;
}
 if(isNaN(new Date(row[2]))) {
f1=f1 + 'row ' + rownumber + '-' + 'PO date' + ',';
return;
}
if(!row[3]){
...
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Vendor id' + ',';
return;
}
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Vendor' + ',';
return;
}
...
f1=f1 + 'row ' + rownumber + '-' + 'GST' + ',';
return;
}
if(!row[8]){
f1=f1 + 'row ' + rownumber + '-' + 'Terms' + ',';
return;
}
if(!row[9]){
f1=f1 + 'row ' + rownumber + '-' + 'PO type' + ',';
return;
}
if(!row[10]){
f1=f1 + 'row ' + rownumber + '-' + 'Approval' + ',';
return;
}
if(!row[11]){
f1=f1 + 'row ' + rownumber + '-' + 'Approved by username' + ',';
return;
}
if(!row[12]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,ponumber,podate,description,vendorid,vendor,amount,gst,terms,potype,approval,approvaluser,doclink,status <br /><br />
