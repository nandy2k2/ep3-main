...
const setmobileno=(id)=> {
if(transcript) {
mobilenoref.current.value=transcript;
 }
 }
const setemail=(id)=> {
if(transcript) {
...
status1:'Submitted',
 ...
 <button onClick={setmobileno}>Set Mobile no</button>
...
<p>Mobile no</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={mobilenoref} /><br /><br />
