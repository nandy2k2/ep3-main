...
const setemode=(id)=> {
if(transcript) {
emoderef.current.value=transcript;
 }
 }
...
const emode=emoderef.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createtblemitterbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
status1:'Submitted',
 ...
 <button onClick={setemode}>Set Agent code</button>
...
<p>Agent code</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={emoderef} /><br /><br />

<p>Description</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={descriptionref} /><br /><br />

<InputLabel id="isactive">Is active</InputLabel><Select labelId="isactive"
id="isactive"
