...
return;
  ...
  const searchapi = async (rownumber,poid,item,description,amount,gst,purchasetype,category,doclink,status1) => {
...
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Purchase type' + ',';
return;
}
if(!row[6]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      poid,item,description,amount,gst,purchasetype,category,doclink,status <br /><br />
