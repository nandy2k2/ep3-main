...
return;
  ...
  const searchapi = async (rownumber,facultyid,faculty,wday,period,wdayp,program,course,semester,section,year,type,level,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      facultyid,faculty,wday,period,wdayp,program,course,semester,section,year,type,level,status <br /><br />
