...
const setnewprogram=(id)=> {
if(transcript) {
newprogramref.current.value=transcript;
 }
 }
...
const newprogram=newprogramref.current.value;
...
status1:'Submitted',
 ...
 <button onClick={setnewprogram}>Set Program joining</button>
...
<p>Program joining</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={newprogramref} /><br /><br />
