...
return;
  ...
  const searchapi = async (rownumber,year,program,programcode,course,total,slow,advanced,diverse,doclink,type,level,status1) => {
...
f1=f1 + 'row ' + rownumber + '-' + 'No of slow learners' + ',';
return;
}
if(!row[6] || isNaN(row[6])){
f1=f1 + 'row ' + rownumber + '-' + 'No of advanced learners' + ',';
return;
}
if(!row[7] || isNaN(row[7])){
f1=f1 + 'row ' + rownumber + '-' + 'No fo students with diverse need' + ',';
return;
}
if(!row[8]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,program,programcode,course,total,slow,advanced,diverse,doclink,type,level,status <br /><br />
