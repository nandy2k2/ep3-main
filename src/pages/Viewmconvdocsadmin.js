...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/convdocsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getconvdocscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getconvdocssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
