...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/nn6clubsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getnn6clubscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getnn6clubssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
