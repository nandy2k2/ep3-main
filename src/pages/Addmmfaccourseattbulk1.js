...
return;
        ...
        alert('Task will be completed in thirty minutes for eligible rows.');
        setLink(f1);

    };


  const searchapi = async (rownumber,year,coursename,coursecode,co,component,student,regno,marks,weightage,totalmarks,percentage,status1) => {
...
//alert(coursetitle + '-' + dateadded);
    ...
    const weightage1=0.1;
    const percentage1=(parseFloat(marks))/parseFloat(totalmarks)*100;
...
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Assessment component' + ',';
return;
}
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Student' + ',';
...
f1=f1 + 'row ' + rownumber + '-' + 'Marks obtained' + ',';
return;
}
if(!row[8] || isNaN(row[8])){
f1=f1 + 'row ' + rownumber + '-' + 'Assessment weightage' + ',';
return;
}
if(!row[9] || isNaN(row[9])){
f1=f1 + 'row ' + rownumber + '-' + 'Total marks' + ',';
return;
}
...
<br />
      ...
      year,coursename,coursecode,co,component,student,regno,marks,weightage,totalmarks,percentage,status <br /><br />
