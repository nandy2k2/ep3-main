...
return;
  ...
  const searchapi = async (rownumber,year,acreditation,criteria,qno,question,keywords,sequence,doclink,type,level,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Accreditation' + ',';
return;
}
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Criteria' + ',';
return;
}
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Question no' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Question' + ',';
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,acreditation,criteria,qno,question,keywords,sequence,doclink,type,level,status <br /><br />
