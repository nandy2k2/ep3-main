...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/psurgerydocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getpsurgerycount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getpsurgerysecond', {
          params: {
            token: token,
            colid: colid,
            user: user
