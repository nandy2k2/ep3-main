...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/mjournal2docs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getmjournal2count', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getmjournal2second', {
          params: {
            token: token,
            colid: colid,
            user: user
