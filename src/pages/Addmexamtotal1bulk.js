...
return;
  ...
  const searchapi = async (rownumber,year,examcode,student,regno,program,programcode,course,coursecode,semester,credits,intmarks,extmarks,result,type,level,status1) => {
...
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Programcode' + ',';
return;
}
if(!row[6]){
...
f1=f1 + 'row ' + rownumber + '-' + 'Internal marks' + ',';
return;
}
if(!row[11] || isNaN(row[11])){
f1=f1 + 'row ' + rownumber + '-' + 'External marks' + ',';
return;
}
if(!row[12]){
f1=f1 + 'row ' + rownumber + '-' + 'Result' + ',';
return;
}
if(!row[13]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,examcode,student,regno,program,programcode,course,coursecode,semester,credits,intmarks,extmarks,result,type,level,status <br /><br />
