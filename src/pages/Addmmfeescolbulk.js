...
return;
  ...
  const searchapi = async (rownumber,year,programcode,student,regno,feegroup,feeitem,semester,feecategory,paydate,amount,paymode,payref,paystatus,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,programcode,student,regno,feegroup,feeitem,semester,feecategory,paydate,amount,paymode,payref,paystatus,status <br /><br />
