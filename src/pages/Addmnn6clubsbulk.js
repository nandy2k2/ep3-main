...
return;
  ...
  const searchapi = async (rownumber,year,club,clubtype,activity,actdate,participants,location,doclink,type,level,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Hackathon or Ideathon name' + ',';
return;
}
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Club type' + ',';
return;
}
if(!row[3]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,club,clubtype,activity,actdate,participants,location,doclink,type,level,status <br /><br />
