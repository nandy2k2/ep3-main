...
const awards=awardsref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v1/createncas253byfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
<InputLabel id="type">Type of Awards or Fellowship</InputLabel><Select labelId="type"
id="type"
inputRef={typeref}
sx={{ width: '100%'}}
>
...
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label="Awards or Fellowship name"  variant="outlined" inputRef={awardsref} /><br /><br />
