...
return;
  ...
  const searchapi = async (rownumber,ppatient,puser,admid,family,illness,duration,relation,status1) => {
...
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Family' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Illness' + ',';
return;
}
if(!row[5]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      ppatient,puser,admid,family,illness,duration,relation,status <br /><br />
