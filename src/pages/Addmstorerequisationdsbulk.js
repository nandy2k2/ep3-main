...
return;
  ...
  const searchapi = async (rownumber,year,itemcode,itemname,store,storeid,reqdate,quantity,reqstatus,poid,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,itemcode,itemname,store,storeid,reqdate,quantity,reqstatus,poid,status <br /><br />
