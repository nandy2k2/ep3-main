...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/requisationdsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getrequisationdscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getrequisationdssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
