...
import AddUserModalBulk from './AddmkeiquestionModelbulk';
...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/getkeiquestionModelbyfac', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
      const response = await ep1.get('/api/v2/getkeiquestionModelcountbyfac', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdatasecond = async () => {
      const response = await ep1.get('/api/v2/getkeiquestionModelsecondbyfac', {
        params: {
          token: token,
          colid: colid,
          user: user
