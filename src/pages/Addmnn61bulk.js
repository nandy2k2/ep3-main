...
return;
  ...
  const searchapi = async (rownumber,year,club,activity,actdate,participants,location,doclink,type,level,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Club name' + ',';
return;
}
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Club activity' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,club,activity,actdate,participants,location,doclink,type,level,status <br /><br />
