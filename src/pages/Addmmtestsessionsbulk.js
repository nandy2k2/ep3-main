...
return;
  ...
  const searchapi = async (rownumber,testid,session,starttime,endtime,type,level,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      testid,session,starttime,endtime,type,level,status <br /><br />
