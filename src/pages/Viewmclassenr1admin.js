...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/classenr1docs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getclassenr1count', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getclassenr1second', {
          params: {
            token: token,
            colid: colid,
            user: user
