...
return;
  ...
  const searchapi = async (rownumber,year,title,category,description,image,applylink,level,type,status1) => {
...
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Image' + ',';
return;
}
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Apply link' + ',';
return;
}
if(!row[6]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,title,category,description,image,applylink,level,type,status <br /><br />
