...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/msyllabusdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getmsyllabuscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getmsyllabussecond', {
          params: {
            token: token,
            colid: colid,
            user: user
