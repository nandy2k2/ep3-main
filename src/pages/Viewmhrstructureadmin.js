...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/hrstructuredocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/gethrstructurecount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/gethrstructuresecond', {
          params: {
            token: token,
            colid: colid,
            user: user
