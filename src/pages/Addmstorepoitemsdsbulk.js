...
return;
  ...
  const searchapi = async (rownumber,year,poid,vendor,vendorid,quantity,price,description,reqdate,postatus,itemid,itemname,status1) => {
...
if(!row[8]){
f1=f1 + 'row ' + rownumber + '-' + 'PO status' + ',';
return;
}
if(!row[9]){
f1=f1 + 'row ' + rownumber + '-' + 'Item id' + ',';
return;
}
if(!row[10]){
f1=f1 + 'row ' + rownumber + '-' + 'Item name' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,poid,vendor,vendorid,quantity,price,description,reqdate,postatus,itemid,itemname,status <br /><br />
