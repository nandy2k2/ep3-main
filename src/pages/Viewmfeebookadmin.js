...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/feebookdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getfeebookcount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getfeebooksecond', {
          params: {
            token: token,
            colid: colid,
            user: user
