...
const levelref=useRef();
    ...
    const {
      ...
      const setgroup1=(id)=> {
if(transcript) {
group1ref.current.value=transcript;
 }
 }
const setaccreditation=(id)=> {
if(transcript) {
accreditationref.current.value=transcript;
 }
 }
const setqno=(id)=> {
if(transcript) {
...
const group1=group1ref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createngroupaccrbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
status1:'Submitted',
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      <p>{transcript}</p>
       ...
       <button onClick={setgroup1}>Set Group</button>
 <button onClick={setaccreditation}>Set Accreditation</button>
 ...
 <button onClick={setlevel}>Set Level</button>
    ...
    <p>Group</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={group1ref} /><br /><br />

<p>Accreditation</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={accreditationref} /><br /><br />
