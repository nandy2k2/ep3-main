...
return;
  ...
  const searchapi = async (rownumber,testid1,sectionid1,question,optiona,optionb,optionc,optiond,correcta,type,level,status1) => {
...
const sectionid=global1.isectionid;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createmiqnewbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
