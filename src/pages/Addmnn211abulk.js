...
return;
  ...
  const searchapi = async (rownumber,committee,comcode,year,ugc,member,sme,meetingdate,doclink,type,level,status1) => {
...
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Is UGC 2018 regulation compliant' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Member name' + ',';
return;
}
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Is SME' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      committee,comcode,year,ugc,member,sme,meetingdate,doclink,type,level,status <br /><br />
