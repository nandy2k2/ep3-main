...
const deanref=useRef();
const deanemailref=useRef();
...
const setdean=(id)=> {
if(transcript) {
deanref.current.value=transcript;
 }
 }
const setdeanemail=(id)=> {
if(transcript) {
deanemailref.current.value=transcript;
 }
 }
const setlevel=(id)=> {
if(transcript) {
...
const dean=deanref.current.value;
const deanemail=deanemailref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createunivfacbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
status1:'Submitted',
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      <p>{transcript}</p>
       ...
       <button onClick={setfaculty}>Set Fadulty</button>
 ...
 <button onClick={setdean}>Set Dean</button>
 <button onClick={setdeanemail}>Set Dean email</button>
...
<p>Dean</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={deanref} /><br /><br />

<p>Dean email</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={deanemailref} /><br /><br />
