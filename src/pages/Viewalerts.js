...
{
field:'affiliated',
headerName:'If affiliated to same institution',
type:'text',
width:200,
editable:true,
valueFormatter: (params) => {
...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/getbookbyfac', {
        params: {
          token: token,
          colid: colid,
          user: user
