...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/lpubeditionsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getlpubeditionscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getlpubeditionssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
