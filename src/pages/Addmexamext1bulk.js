...
return;
  ...
  const searchapi = async (rownumber,examcode,student,regno,program,programcode,course,coursecode,semester,credits,extmarks,type,level,status1) => {
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createexamext1byfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      examcode,student,regno,program,programcode,course,coursecode,semester,credits,extmarks,type,level,status <br /><br />
