...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/padmhistorydocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getpadmhistorycount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getpadmhistorysecond', {
          params: {
            token: token,
            colid: colid,
            user: user
