...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/wcolscheduledocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getwcolschedulecount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getwcolschedulesecond', {
          params: {
            token: token,
            colid: colid,
            user: user
