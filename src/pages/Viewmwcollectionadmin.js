...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/wcollectiondocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getwcollectioncount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getwcollectionsecond', {
          params: {
            token: token,
            colid: colid,
            user: user
