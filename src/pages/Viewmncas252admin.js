...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v1/ncas252docs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v1/getncas252count', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v1/getncas252second', {
          params: {
            token: token,
            colid: colid,
            user: user
