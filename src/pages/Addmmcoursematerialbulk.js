...
return;
  ...
  const searchapi = async (rownumber,year,course,coursecode,slideno,title,description,imagelink,voicetext,doclink,type,mode,status1) => {
...
if(!row[7]){
f1=f1 + 'row ' + rownumber + '-' + 'Voice text' + ',';
return;
}
if(!row[8]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,course,coursecode,slideno,title,description,imagelink,voicetext,doclink,type,mode,status <br /><br />
