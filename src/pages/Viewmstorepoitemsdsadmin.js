...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/storepoitemsdsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getstorepoitemsdscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getstorepoitemsdssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
