...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/convdatesdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getconvdatescount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getconvdatessecond', {
          params: {
            token: token,
            colid: colid,
            user: user
