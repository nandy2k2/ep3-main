...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/cashbookdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getcashbookcount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getcashbooksecond', {
          params: {
            token: token,
            colid: colid,
            user: user
