...
return;
  ...
  const searchapi = async (rownumber,item,s1,s2,s3,s4,s5,s6,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + '0 to 6 months' + ',';
return;
}
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + '6 to 12 months' + ',';
return;
}
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + '12 to 18 months' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + '18 to 24 months' + ',';
return;
}
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + '24 to 30 months' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + '30 to 36 months' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      item,s1,s2,s3,s4,s5,s6,status <br /><br />
