...
return;
  ...
  const searchapi = async (rownumber,campus,faculty,department,description,address,hod,hodemail,type,level,status1) => {
...
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Hod' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Hod email' + ',';
return;
}
if(!row[7]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      campus,faculty,department,description,address,hod,hodemail,type,level,status <br /><br />
