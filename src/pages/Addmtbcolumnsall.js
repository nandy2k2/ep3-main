...
const setfields=(id)=> {
if(transcript) {
fieldsref.current.value=transcript;
 }
 }
...
const fields=fieldsref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createtbcolumnsallbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
<p>Fields</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={fieldsref} /><br /><br />
