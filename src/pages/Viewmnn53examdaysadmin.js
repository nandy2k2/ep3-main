...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/nn53examdaysdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getnn53examdayscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getnn53examdayssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
