...
const year=yearref.current.value;
const yearstatus=yearstatusref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createkeiyearbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
<InputLabel id="yearstatus">Year status</InputLabel><Select labelId="yearstatus"
id="yearstatus"
inputRef={yearstatusref}
sx={{ width: '100%'}}
>
