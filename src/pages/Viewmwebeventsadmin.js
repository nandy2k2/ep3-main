...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/webeventsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getwebeventscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getwebeventssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
