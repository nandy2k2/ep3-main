...
import AddUserModal from './Addmstudawardsnewstud';
import AddUserModalBulk from './Addmstudawardsnewbulkstud';
...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/getstudawardsnewstudbyfac', {
        params: {
          token: token,
          colid: colid,
          user: user,
    ...
    const getgraphdata = async () => {
      const response = await ep1.get('/api/v2/getstudawardsnewcountbystud', {
        params: {
          token: token,
          colid: colid,
          user: user,
    ...
    const getgraphdatasecond = async () => {
      const response = await ep1.get('/api/v2/getstudawardsnewsecondbystud', {
        params: {
          token: token,
          colid: colid,
          user: user,
