...
import { TextField, Stack, Button, Box, Card, Typography, Container, AppBar, Divider, InputLabel, MenuItem, Drawer, IconButton, List, ListItem, ListItemButton, ListItemText, Toolbar, CardMedia, CardContent, CardActions, ListItemIcon, useMediaQuery, Select } from '@mui/material';
...
function CampusWebsite(props) {
  ...
  const onButtonClickloginstud = async () => {
    ...
    const container =
        ...
        const mgmtsal=180000;
        const mgmtsub=mgmtsubref.current.value;
        if(!mgmthours || !mgmtsub) {
            alert('Please select management consulting hours per week and also during submission of final report.');
            return;
        }
        ...
        if(!leadhours || !leadnumber || !supporthours || !supportnumber || !offlineno || !onlineno || !onlinesupport || !offlinetraining) {
            alert('All fields are required.');
            return;
        }

        const leadsal=280;
        const supportsal=200;
        ...
        const profitability=30;
        var mgmtamount=year * mgmthours * mgmtsal / 160 + mgmtsub * mgmtsal / 160;

        const students=studentsref.current.value;
        const studrev=students * year * 150;




        amount=mgmtamount + workshopamount + leadamount + supportamount + studrev;

        var prof=100 - profitability;
        amount=Math.round(amount/prof * 100);

        var newmessage='Indicative Pricing ' + amount + '.';
                    ...
                    <Box sx={{ position: "relative",  margin: "20px" }}>
                         ...
                         <Box>
                                ...
                                <Typography variant='h6' component="h6" sx={{ px: 6 }}>
                                    Generative AI based Accreditation Management Software - Rs. 150 per month per user.
                                </Typography>
                                    <br /><br />
                                <Typography variant='h6' component="h6" sx={{ px: 6 }}>
                                    Consulting Online - Rs. 1000 per hour.
                                </Typography>
                                <br /><br />
                                <Typography variant='h6' component="h6" sx={{ px: 6 }}>
                                    Consulting workshop - Rs. 10000 per day plus travel expenses and accomodation for 2 members.
                                </Typography>
                                <br /><br />
                                <Typography variant='h6' component="h6" sx={{ px: 6 }}>
                                    Academic and Administrative Audit - Rs. 50,000 per year plus travel and accomodation expenses for 2 members. Data to be entered in portal.
                                </Typography>
                                <br /><br />
                                <Typography variant='h6' component="h6" sx={{ px: 6 }}>
                                    Green Audit - Rs. 50,000 per year plus travel and accomodation expenses for 2 members. Data to be entered in portal.
                                </Typography>
                                <br /><br />
                                <Typography variant='h6' component="h6" sx={{ px: 6 }}>
                                    Accreditation Readiness Audit - Rs. 50,000 per year plus travel and accomodation expenses for 2 members. Data to be entered in portal.
                                </Typography>
                                <br /><br />
                        ...
                        <MenuItem value="48">12 months</MenuItem>
                             ...
                             <Box>
                                ...
                                <TextField id="outlined-basic"  type="number" sx={{ width: "300px"}} label="Senior Consultant hours per week"  variant="outlined" inputRef={mgmthoursref} />
                                
                                <TextField id="outlined-basic"  type="number" sx={{ width: "360px", marginLeft: 3}} label="Senior Consultant hours during submission"  variant="outlined" inputRef={mgmtsubref} />
                        ...
                        <TextField id="outlined-basic"  type="number" sx={{ width: "300px"}} label="Lead hours per week"  variant="outlined" inputRef={leadhoursref} />
                        
                        <TextField id="outlined-basic"  type="number" sx={{ width: "300px", marginLeft: 3}} label="No of leads"  variant="outlined" inputRef={leadnumberref} />
                        ...
                        <TextField id="outlined-basic"  type="number" sx={{ width: "300px"}} label="Support hours per week"  variant="outlined" inputRef={supporthoutsref} />
                        
                        <TextField id="outlined-basic"  type="number" sx={{ width: "300px", marginLeft: 3}} label="No of support staff"  variant="outlined" inputRef={supportnumberref} />
                        ...
                        <TextField id="outlined-basic"  type="number" sx={{ width: "300px"}} label="Offline workshop total"  variant="outlined" inputRef={offlinenoref} />
                        <TextField id="outlined-basic"  type="number" sx={{ width: "300px", marginLeft: 3}} label="online workshop hrs per wk lead"  variant="outlined" inputRef={onlinenoref} />
                        <TextField id="outlined-basic"  type="number" sx={{ width: "300px", marginLeft: 3}} label="online workshop hrs per wk support"  variant="outlined" inputRef={onlinesupportref} />
                        <TextField id="outlined-basic"  type="number" sx={{ width: "300px", marginLeft: 3}} label="offline training per week"  variant="outlined" inputRef={offlinetrainingref} />
                        ...
                        <TextField id="outlined-basic"  type="number" sx={{ width: "300px", marginLeft: 0}} label="No of users per month"  variant="outlined" inputRef={studentsref} />
                        ...
                        <Button onClick={calculaterev}
                             variant="contained"
                             color="secondary"
                             style={{ padding: '5px 10px', marginLeft: '0px', fontSize: '12px', height: '30px', width: '180px' }}
                           >
                            Suggest pricing
                           </Button>
                           ...
                           <br /><br /> */}
                             ...
                             For customized pricing please contact Sulagna at 9830218258 or sulagna.singharoy@epaathsala.com.
