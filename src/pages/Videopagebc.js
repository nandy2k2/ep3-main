      ...
      case "text-image":
        return (
          <Box className={`${styles.videoContainer} ${contentClasses}`}>
            ...
            {image && <img src={image} style={{display: 'block', maxWidth: '100%', maxHeight: '100%'}} alt="content" />}
          </Box>
        );
      case "image":
        return (
          <Box className={`${styles.videoContainer} ${contentClasses}`}>
            <img src={image} style={{display: 'block', maxWidth: '100%', maxHeight: '100%'}} alt="content" />
          </Box>
        );
      case "text":
        return (
