...
const setallergy=(id)=> {
if(transcript) {
allergyref.current.value=transcript;
 }
 }
...
status1:'Submitted',
 ...
 <button onClick={setallergy}>Set Allergy</button>
...
<p>Allergy</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={allergyref} /><br /><br />
