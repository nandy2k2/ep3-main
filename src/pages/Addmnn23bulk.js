...
return;
  ...
  const searchapi = async (rownumber,faculty,designation,year,gender,state1,state2,country,foreigner,category1,category2,type,level,status1) => {
...
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Is Same State' + ',';
return;
}
if(!row[5]){
...
if(!row[7]){
f1=f1 + 'row ' + rownumber + '-' + 'Is Foreigner' + ',';
return;
}
if(!row[8]){
...
if(!row[9]){
f1=f1 + 'row ' + rownumber + '-' + 'Other category' + ',';
return;
}
if(!row[10]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      faculty,designation,year,gender,state1,state2,country,foreigner,category1,category2,type,level,status <br /><br />
