...
return;
  ...
  const searchapi = async (rownumber,year,program,programcode,course,coursecode,student,regno,learning,gender,classgroup,coursetype,semester,active,status1) => {
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createclassenr1studbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,program,programcode,course,coursecode,student,regno,learning,gender,classgroup,coursetype,semester,active,status <br /><br />
