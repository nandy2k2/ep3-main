...
return;
  ...
  const searchapi = async (rownumber,year,coursename,coursecode,type,program,programcode,semester,hours,username,faculty,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,coursename,coursecode,type,Program, Programcode, Semester, Hours (Number), username,faculty name, status <br /><br />
