...
const studenrollref=useRef();
const studcompleteref=useRef();
...
const setenddate=(id)=> {
if(transcript) {
enddateref.current.value=transcript;
 }
 }
...
const duration=durationref.current.value;
const studenroll=studenrollref.current.value;
const studcomplete=studcompleteref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createmvacbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
<p>End date</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={enddateref} /><br /><br />

<p>Duration</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={durationref} /><br /><br />

<p>Students enrolled</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={studenrollref} /><br /><br />

<p>Students completed</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={studcompleteref} /><br /><br />
...
sx={{ width: '100%'}}
>
<MenuItem value="Value added course">Value added course</MenuItem>
<MenuItem value="Skill development course">Skill development course</MenuItem>
<MenuItem value="Life skill course">Life skill course</MenuItem>
<MenuItem value="Latest trends">Latest trends</MenuItem>
