...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/hrsalarydocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/gethrsalarycount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/gethrsalarysecond', {
          params: {
            token: token,
            colid: colid,
            user: user
