...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/hrsalstructuredocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/gethrsalstructurecount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/gethrsalstructuresecond', {
          params: {
            token: token,
            colid: colid,
            user: user
