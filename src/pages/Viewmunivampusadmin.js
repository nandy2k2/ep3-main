...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/univampusdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getunivampuscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getunivampussecond', {
          params: {
            token: token,
            colid: colid,
            user: user
