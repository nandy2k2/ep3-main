...
return;
  ...
  const searchapi = async (rownumber,structure,structureid,employee,empid,component,amount,type,level,effectivedate,applieddate,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Structureid' + ',';
return;
}
if(!row[2]){
...
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Employee userid' + ',';
return;
}
if(!row[4]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      structure,structureid,employee,empid,component,amount,type,level,effectivedate,applieddate,status <br /><br />
