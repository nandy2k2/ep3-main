...
return;
  ...
  const searchapi = async (rownumber,patient,puser,admid,activity,bedno,bedtype,activitydate,doccomments,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      patient,puser,admid,activity,bedno,bedtype,activitydate,doccomments,status <br /><br />
