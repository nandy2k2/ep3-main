...
return;
  ...
  const searchapi = async (rownumber,templateid,template,faculty,facultyid,level,category,type,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      templateid,template,faculty,facultyid,level,category,type,status <br /><br />
