...
import AddUserModal from './Addmprojectsadmin';
...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/projectsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getprojectscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getprojectssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
