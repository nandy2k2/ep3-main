...
const extauditref=useRef();
const intauditref=useRef();
...
const year=yearref.current.value;
const extaudit=extauditref.current.value;
const intaudit=intauditref.current.value;
...
<InputLabel id="extaudit">External audit</InputLabel><Select labelId="extaudit"
id="extaudit"
inputRef={extauditref}
sx={{ width: '100%'}}
>
...
<InputLabel id="intaudit">Internal audit</InputLabel><Select labelId="intaudit"
id="intaudit"
inputRef={intauditref}
sx={{ width: '100%'}}
>
<MenuItem value="Yes">Yes</MenuItem>
<MenuItem value="No">No</MenuItem>
...
<InputLabel id="budget">Budget</InputLabel><Select labelId="budget"
id="budget"
inputRef={budgetref}
sx={{ width: '100%'}}
>
