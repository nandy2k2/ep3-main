...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/vendordsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getvendordscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getvendordssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
