...
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label="Course"  variant="outlined" inputRef={courseref} /><br /><br />
...
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label="No of credits"  variant="outlined" inputRef={creditref} /><br /><br />
