...
export default function PublicAdmissionApplyTabbedProgramCredentialDraftPage() {
          ...
          <Paper sx={{ p: 3 }}>
            ...
            {activeTab === 0 && (
              <Grid container spacing={2}>
                ...
                {renderText("username", "Username", { required: true })}
                {renderText("password", "Password", { required: true, type: "password" })}
