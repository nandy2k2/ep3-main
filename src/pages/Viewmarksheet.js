       ...
       const accreditationref=useRef();
        ...
        const logolinkref=useRef();
         ...
         const onButtonClickgo = async() => {
              ...
              //alert(row._id);
            //   global1.logolink=logolinkref.current.value;
              global1.msexamcode=exam;
              global1.msprogram=program;
              global1.mssemester=semesterref.current.value;
            //   global1.msyear=yearref.current.value;
            global1.msyear=year;
              navigate('/studmarksheet');
...
return '';
    ...
    const coursetitleref = useRef();
        ...
        const handleyearchange = async (e) => {
          ...
          const response = await ep1.get('/api/v2/getmexamdcode', {
            params: {
              token: token,
              colid: colid,
              year:year1,
         ...
         const handlexamchange = async (e) => {
          ...
          const response = await ep1.get('/api/v2/getmexamprograms', {
            params: {
              token: token,
              colid: colid,
              year:year,
          ...
          const response = await ep1.get('/api/v2/getmexamsemester', {
            params: {
              token: token,
              colid: colid,
              year:year,
...
{/* <TextField id="outlined-basic"  type="text" sx={{ width: "60%"}} label="Logo link"  variant="outlined" inputRef={logolinkref} /><br /><br /> */}

     
     <Button onClick={onButtonClickgo}
                  variant="contained"
                  color="secondary"
