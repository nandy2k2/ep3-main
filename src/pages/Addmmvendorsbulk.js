...
return;
  ...
  const searchapi = async (rownumber,vendor,address,pan,gst,state,type,apprstatus,doclink,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      vendor,address,pan,gst,state,type,apprstatus,doclink,status <br /><br />
