...
return;
  ...
  const searchapi = async (rownumber,year,course,coursecode,cocode,co,type,targetlevel,status1) => {
...
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Target level' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,course,coursecode,cocode,co,type,targetlevel,status <br /><br />
