  ...
  const navigate = useNavigate();
    ...
    const response = await ep1.get('/api/v2/testgemini', {
          params: {
              ...
              colid: colid,
              apikey: apikey,
              question:'Create a detailed report on ' + keywords + ' with focus on ' + keywords
          }
...
<br /><br /> */}
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label="Topic"  variant="outlined" inputRef={topicref} /><br /><br />
<br /><br />
