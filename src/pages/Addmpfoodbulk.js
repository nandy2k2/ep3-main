...
return;
  ...
  const searchapi = async (rownumber,patient,puser,type,foodtype,amount,fooddate,foodstatus,status1) => {
...
f1=f1 + 'row ' + rownumber + '-' + 'Food date' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Food status' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      patient,puser,type,foodtype,amount,fooddate,foodstatus,status <br /><br />
