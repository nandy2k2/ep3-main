...
return;
  ...
  const searchapi = async (rownumber,year,pubid,publication,edition,pubmonth,pubstatus,mode,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Publication id' + ',';
return;
}
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Publication' + ',';
return;
}
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Edition' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Publication month' + ',';
return;
}
if(!row[5]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,pubid,publication,edition,pubmonth,pubstatus,mode,status <br /><br />
