...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/convfeesdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getconvfeescount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getconvfeessecond', {
          params: {
            token: token,
            colid: colid,
            user: user
