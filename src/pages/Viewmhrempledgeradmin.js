...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/hrempledgerdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/gethrempledgercount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/gethrempledgersecond', {
          params: {
            token: token,
            colid: colid,
            user: user
