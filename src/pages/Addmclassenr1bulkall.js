...
return;
  ...
  const searchapi = async (rownumber,year,program,programcode,course,coursecode,student,regno,learning,gender,classgroup,coursetype,semester,active,username,faculty,status1) => {
...
if(!row[7]){
f1=f1 + 'row ' + rownumber + '-' + 'Learning level' + ',';
return;
}
if(!row[8]){
...
if(!row[9]){
f1=f1 + 'row ' + rownumber + '-' + 'Class group' + ',';
return;
}
if(!row[10]){
f1=f1 + 'row ' + rownumber + '-' + 'Course type' + ',';
return;
}
if(!row[11]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,program,programcode,course,coursecode,student,regno,learning,gender,classgroup,coursetype,semester,active,username,faculty,status <br /><br />
