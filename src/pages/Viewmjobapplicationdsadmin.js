...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/jobapplicationdsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getjobapplicationdscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getjobapplicationdssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
