...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/nallaccransdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getnallaccranscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getnallaccranssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
