...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/prtemplatedocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getprtemplatecount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getprtemplatesecond', {
          params: {
            token: token,
            colid: colid,
            user: user
