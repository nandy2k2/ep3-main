...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v1/ncas243docs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v1/getncas243count', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v1/getncas243second', {
          params: {
            token: token,
            colid: colid,
            user: user
