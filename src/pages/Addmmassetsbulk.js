...
return;
  ...
  const searchapi = async (rownumber,year,assettype,asset,category,purchasedate,vendorid,poid,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Asset type' + ',';
return;
}
if(!row[2]){
...
f1=f1 + 'row ' + rownumber + '-' + 'Purchase date' + ',';
return;
}
if(!row[5]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,assettype,asset,category,purchasedate,vendorid,poid,status <br /><br />
