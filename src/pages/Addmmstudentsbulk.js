...
return;
  ...
  const searchapi = async (rownumber,student,regno,rollno,program,programcode,batch,year,gender,category,pwd,minority,username,password,enabled,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      student,regno,rollno,program,programcode,batch,year,gender,category,pwd,minority,username,password,enabled,status <br /><br />
