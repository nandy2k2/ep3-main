...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/getmsyllabusbycoursecode', {
        params: {
          token: token,
          colid: colid,
          user: user,
    ...
    const getgraphdata = async () => {
      const response = await ep1.get('/api/v2/getmsyllabuscountbycoursecode', {
        params: {
          token: token,
          colid: colid,
          user: user,
    ...
    const getgraphdatasecond = async () => {
      const response = await ep1.get('/api/v2/getmsyllabussecondbycoursecode', {
        params: {
          token: token,
          colid: colid,
          user: user,
