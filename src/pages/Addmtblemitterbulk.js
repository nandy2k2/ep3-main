...
return;
  ...
  const searchapi = async (rownumber,title,emode,description,isactive,domain,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Agent code' + ',';
return;
}
if(!row[2]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      title,emode,description,isactive,domain,status <br /><br />
