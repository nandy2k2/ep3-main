...
return;
  ...
  const searchapi = async (rownumber,vendorid,vendor,bank,account,accno,ifsc,branch,acctype,banktype,status1) => {
...
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Account name' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Account no' + ',';
return;
}
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'IFSC code' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Branch' + ',';
return;
}
if(!row[7]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      vendorid,vendor,bank,account,accno,ifsc,branch,acctype,banktype,status <br /><br />
