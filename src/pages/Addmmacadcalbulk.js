...
return;
  ...
  const searchapi = async (rownumber,academicyear,program,programcode,ativity,description,activitydate,type,level,status1) => {
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createmacadcalbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      academicyear,program,programcode,ativity,description,activitydate,type,level,status <br /><br />
