...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/vendoritemdsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getvendoritemdscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getvendoritemdssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
