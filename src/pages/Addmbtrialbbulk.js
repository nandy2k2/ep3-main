...
return;
  ...
  const searchapi = async (rownumber,year,accounting,amount,nature,purpose,department,bank,ledgerref,type,level,status1) => {
...
if(!row[7]){
f1=f1 + 'row ' + rownumber + '-' + 'Ledger ref' + ',';
return;
}
if(!row[8]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,accounting,amount,nature,purpose,department,bank,ledgerref,type,level,status <br /><br />
