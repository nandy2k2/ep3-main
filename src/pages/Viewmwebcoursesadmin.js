...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/webcoursesdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getwebcoursescount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getwebcoursessecond', {
          params: {
            token: token,
            colid: colid,
            user: user
