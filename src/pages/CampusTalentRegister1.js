...
const Signup = () => {
  ...
  const searchapi = async () => {
    ...
    if(promocode=='TRISHIKA') {
        amount=300;
        alert('Congratulations! You have got a discount of Rs. 100');
    } 
    ...
    const paydate=new Date(paydate1);
        ...
        var orderid=dt1.getFullYear() + month1 + dt1.getDate();

        //navigate('https://campus.technology/campustalent1.php?colid=111362&email=' + email + '&phone=' + phone + '&username=' + username + '&colid=111362&type=CampusTalent&amount=' + amount);
        // window.open('https://campus.technology/campustalent1.php?colid=111362&email=' + email + '&phone=' + phone + '&username=' + username + '&colid=111362&type=CampusTalent&amount=' + amount, '_blank');
        window.location.href='https://campus.technology/campustalent1.php?colid=111362&orderid=' + orderid + '&email=' + email + '&phone=' + phone + '&user=' + username + '&type=CampusTalent&amount=' + amount;
 ...
 */}
        ...
        <Box sx={{ 
          ...
          Times of India group portfolio.
          </Typography>
          <br /><br />
