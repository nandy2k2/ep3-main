...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createnn33bbyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
<MenuItem value="High Performance Computational">High Performance Computational</MenuItem>
<MenuItem value="Animal house">Animal house</MenuItem>
