...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/itemmasterdsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getitemmasterdscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getitemmasterdssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
