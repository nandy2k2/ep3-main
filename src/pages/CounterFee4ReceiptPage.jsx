...
export default function CounterFee4ReceiptPage() {
  ...
  return (
    <MenuPageShell title="Counter Fee Receipt">
      <Box p={3}>
        <Stack direction={{ xs: "column", md: "row" }} justifyContent="space-between" spacing={2} sx={{ mb: 2 }}>
          <Box>
            <Typography variant="h5" fontWeight={800}>Counter Fee Receipt</Typography>
            <Typography variant="body2" color="text.secondary">Search a transaction and generate the redesigned counter fee receipt.</Typography>
          </Box>
        ...
        <Paper sx={{ p: 1, mb: 3, overflowX: "auto" }}>
          ...
          <DataGrid
            ...
            slotProps={{ toolbar: { showQuickFilter: true, csvOptions: { fileName: "counter_fee_receipts" } } }}
