...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/tblemitterdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/gettblemittercount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/gettblemittersecond', {
          params: {
            token: token,
            colid: colid,
            user: user
