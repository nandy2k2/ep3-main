...
return;
  ...
  const searchapi = async (rownumber,year,classid,programcode,program,course,coursecode,student,regno,att,classdate,semester,section,status1) => {
...
if(!row[8]){
f1=f1 + 'row ' + rownumber + '-' + 'Attendance' + ',';
return;
}
 if(isNaN(new Date(row[9]))) {
f1=f1 + 'row ' + rownumber + '-' + 'Class date' + ',';
return;
}
if(!row[10]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,classid,programcode,program,course,coursecode,student,regno,att,classdate,semester,section,status <br /><br />
