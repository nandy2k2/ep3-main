...
const requests=requestsref.current.value;
const resolved=resolvedref.current.value;
const changed=changedref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createnn54byfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={requestsref} /><br /><br />

<p>No of resolutions</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={resolvedref} /><br /><br />

<p>No of changes</p>
<TextField id="outlined-basic"  type="number" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={changedref} /><br /><br />
