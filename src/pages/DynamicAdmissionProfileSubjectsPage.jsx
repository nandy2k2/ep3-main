...
export default function DynamicAdmissionProfileSubjectsPage() {
  ...
  const admissionConfigRows = application ? [
    { id: 1, field: "Stream", value: application.extraFields?.admission_stream || application.programtype || "" },
    { id: 2, field: "Program", value: application.programapplied || "" },
    { id: 3, field: "Semester", value: application.extraFields?.admission_semester || "" },
    { id: 4, field: "Selected Subjects", value: application.extraFields?.admission_subjects || "" },
    { id: 5, field: "Program Code", value: application.programcode || "" }
  ] : [];
      ...
      <Grid item xs={12}>
        <Paper className="admission-profile-print" sx={{ p: 3 }}>
          <Box sx={{ textAlign: "center", mb: 2 }}>
            ...
            <Typography variant="h6" sx={{ mt: 2 }}>Admission Student Profile with Subjects</Typography>
          </Box>
          ...
          {application && (
            <>
              ...
              <Grid container spacing={2} sx={{ mt: 1 }}>
                <Grid item xs={12}>
                  <Typography variant="h6" sx={{ mb: 1 }}>Admission Configuration Details</Typography>
                  <DataGrid
                    rows={admissionConfigRows}
