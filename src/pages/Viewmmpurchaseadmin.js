...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/mpurchasedocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getmpurchasecount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getmpurchasesecond', {
          params: {
            token: token,
            colid: colid,
            user: user
