...
return;
  ...
  const searchapi = async (rownumber,year,quarter,participants,activity,actdate,agenda,location,doclink,type,level,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Quarter' + ',';
return;
}
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Participants' + ',';
return;
}
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Activity date' + ',';
return;
}
...
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Agenda' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Location' + ',';
return;
}
if(!row[7]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,quarter,participants,activity,actdate,agenda,location,doclink,type,level,status <br /><br />
