...
export default function NepLmsTimetableCreatorPage() {
  ...
  return (
    <MenuPageShell title="Timetable Creator">
      <Container maxWidth="xl" sx={{ py: 3 }}>
        <Stack direction={{ xs: "column", md: "row" }} justifyContent="space-between" spacing={2} sx={{ mb: 2 }}>
          <Box>
            <Typography variant="h5" fontWeight={900}>Timetable Creator</Typography>
            <Typography variant="body2" color="text.secondary">Generate a weekly timetable from workload, period configuration and faculty availability.</Typography>
          </Box>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={3}>
              <FormControl fullWidth>
                ...
                <Select label="Timezone" value={form.timezone} onChange={(e) => setField("timezone", e.target.value)}>
                  {timezoneOptions.map((item) => <MenuItem key={item} value={item}>{item} ({timezoneOffsetLabel(item)})</MenuItem>)}
                </Select>
              </FormControl>
            </Grid>
            <Grid item xs={12} md={2}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                placeholder="Example: Keep practical classes in the afternoon. Keep at least one free period between two classes of the same faculty."
              />
            </Grid>
            <Grid item xs={12}>
        ...
        <Paper sx={{ p: 1, mb: 2, overflowX: "auto" }}>
          ...
          <DataGrid
            ...
            slotProps={{ toolbar: { showQuickFilter: true, csvOptions: { fileName: "generated_timetable" } } }}
