...
return;
  ...
  const searchapi = async (rownumber,patient,puser,admid,billdate,description,amount,payref,paystatus,status1) => {
...
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Pay ref' + ',';
return;
}
if(!row[7]){
f1=f1 + 'row ' + rownumber + '-' + 'Pay status' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      patient,puser,admid,billdate,description,amount,payref,paystatus,status <br /><br />
