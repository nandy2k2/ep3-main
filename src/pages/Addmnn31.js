...
const Faccoderef=useRef();
const mlocationref=useRef();
...
const setFaccode=(id)=> {
if(transcript) {
Faccoderef.current.value=transcript;
 }
 }
const setmlocation=(id)=> {
if(transcript) {
mlocationref.current.value=transcript;
 }
 }
const setdoclink=(id)=> {
if(transcript) {
...
const Faccode=Faccoderef.current.value;
const mlocation=mlocationref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createnn31byfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
status1:'Submitted',
 ...
 <button onClick={setFaccode}>Set Facility code</button>
 <button onClick={setmlocation}>Set Location</button>
...
<p>Facility code</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={Faccoderef} /><br /><br />

<p>Location</p>
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={mlocationref} /><br /><br />
