...
return;
  ...
  const searchapi = async (rownumber,vendorname,vendorid,itemid,item,price,discount,status,type,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      vendorname,vendorid,itemid,item,price,discount,status,type,status <br /><br />
