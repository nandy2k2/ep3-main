...
return;
  ...
  const searchapi = async (rownumber,student,phone,email,guardian,gphone,payref,payname,paydate,source,type,status1) => {
...
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Guardian' + ',';
return;
}
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Guardian phone' + ',';
return;
}
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Payment ref' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Payment name' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      student,phone,email,guardian,gphone,payref,payname,paydate,source,type,status <br /><br />
