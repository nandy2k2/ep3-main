...
return;
  ...
  const searchapi = async (rownumber,year,program,programcode,student,regno,project,employer,startdate,enddate,stipend,doclink,type,level,status1) => {
...
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Project' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Employer' + ',';
return;
}
...
f1=f1 + 'row ' + rownumber + '-' + 'End date' + ',';
return;
}
if(!row[9] || isNaN(row[9])){
f1=f1 + 'row ' + rownumber + '-' + 'Stipend' + ',';
return;
}
if(!row[10]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,program,programcode,student,regno,project,employer,startdate,enddate,stipend,doclink,type,level,status <br /><br />
