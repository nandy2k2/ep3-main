...
if(transcript) {
hackathonref.current.value=transcript;
 }
 }
...
const year=yearref.current.value;
const hackathon=hackathonref.current.value;
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      <p>{transcript}</p>
       ...
       <button onClick={sethackathon}>Set Hackathon or Ideathon name</button>
...
<TextField id="outlined-basic"  type="text" sx={{ width: "100%"}} label=""  variant="outlined" inputRef={hackathonref} /><br /><br />
