...
return;
  ...
  const searchapi = async (rownumber,year,course,coursecode,startdate,enddate,duration,studenroll,studcomplete,type,status1) => {
...
f1=f1 + 'row ' + rownumber + '-' + 'Duration' + ',';
return;
}
if(!row[6] || isNaN(row[6])){
f1=f1 + 'row ' + rownumber + '-' + 'Students enrolled' + ',';
return;
}
if(!row[7] || isNaN(row[7])){
f1=f1 + 'row ' + rownumber + '-' + 'Students completed' + ',';
return;
}
if(!row[8]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,course,coursecode,startdate,enddate,duration,studenroll,studcomplete,type,status <br /><br />
