...
// }
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Imagelink' + ',';
return;
}
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Video link' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Doclink' + ',';
return;
}
  ...
  const searchapi = async (rownumber,testid1,questionid1,option,score,imagelink,videolink,doclink,type,difficulty,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Question id' + ',';
return;
}
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Option' + ',';
...
if(!row[8]){
f1=f1 + 'row ' + rownumber + '-' + 'Difficulty' + ',';
return;
}
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      testid,question,option,score,imagelink,videolink,doclink,type,difficulty,status <br /><br />
