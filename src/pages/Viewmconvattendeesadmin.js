...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/convattendeesdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getconvattendeescount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getconvattendeessecond', {
          params: {
            token: token,
            colid: colid,
            user: user
