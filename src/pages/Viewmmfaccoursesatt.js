...
return '';
      ...
      const attainmentm1 = async () => {
        const coursename1=global1.faccoursename;
        const coursecode1=global1.faccoursecode;
       
        navigate('/dashmmfaccoursesatto');
      };

       const attainmentm1s = async () => {
        const coursename1=global1.faccoursename;
        const coursecode1=global1.faccoursecode;
    ...
    const fetchViewPage = async () => {
      const coursename1=global1.faccoursename;
      const coursecode1=global1.faccoursecode;
      const response = await ep1.get('/api/v2/getmfaccoursesattbyfac1', {
        params: {
          token: token,
          colid: colid,
          user: user,
    ...
    return (
      <React.Fragment>
        <Container maxWidth="100%" sx={{ mt: 4, mb: 4 }}>
          Course {faccoursename} {faccoursecode} <br /><br />
