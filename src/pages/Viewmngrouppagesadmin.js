...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/ngrouppagesdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getngrouppagescount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getngrouppagessecond', {
          params: {
            token: token,
            colid: colid,
            user: user
