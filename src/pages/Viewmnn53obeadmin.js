...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/nn53obedocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getnn53obecount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getnn53obesecond', {
          params: {
            token: token,
            colid: colid,
            user: user
