...
import AddUserModal from './Addmpublicationsadmin';
...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/publicationsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getpublicationscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getpublicationssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
