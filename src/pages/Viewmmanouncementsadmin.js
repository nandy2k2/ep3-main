...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/manouncementsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getmanouncementscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getmanouncementssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
