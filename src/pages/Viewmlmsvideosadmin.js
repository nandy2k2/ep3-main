...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/lmsvideosdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getlmsvideoscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getlmsvideossecond', {
          params: {
            token: token,
            colid: colid,
            user: user
