...
return;
  ...
  const searchapi = async (rownumber,title,description,eventdate,eventtime,location,eventday,eventmonth,link,status1) => {
...
if(!row[1]){
f1=f1 + 'row ' + rownumber + '-' + 'Desription' + ',';
return;
}
if(!row[2]){
...
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Event time' + ',';
return;
}
if(!row[4]){
...
if(!row[5]){
f1=f1 + 'row ' + rownumber + '-' + 'Event day' + ',';
return;
}
if(!row[6]){
f1=f1 + 'row ' + rownumber + '-' + 'Event month' + ',';
return;
}
if(!row[7]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      title,description,eventdate,eventtime,location,eventday,eventmonth,link,status <br /><br />
