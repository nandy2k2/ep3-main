...
return;
  ...
  const searchapi = async (rownumber,year,facility,location,agency,doclink,type,level,status1) => {
...
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Agency with MoU' + ',';
return;
}
if(!row[4]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,facility,location,agency,doclink,type,level,status <br /><br />
