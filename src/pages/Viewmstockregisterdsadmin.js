...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/stockregisterdsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getstockregisterdscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getstockregisterdssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
