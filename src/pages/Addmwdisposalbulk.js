...
return;
  ...
  const searchapi = async (rownumber,location,type,agency,disposaldate,disposaltime,vendor,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      location,type,agency,disposaldate,disposaltime,vendor,status <br /><br />
