...
return;
  ...
  const searchapi = async (rownumber,year,storename,storeid,itemname,itemcode,quantityadded,quantityreturn,netquantity,tdate,itemtype,status,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      year,storename,storeid,itemname,itemcode,quantityadded,quantityreturn,netquantity,tdate,itemtype,status,status <br /><br />
