...
return;
  ...
  const searchapi = async (rownumber,location,binid,type,cday,ctime,vendor,amount,status1) => {
...
if(!row[4]){
f1=f1 + 'row ' + rownumber + '-' + 'Collection time' + ',';
return;
}
if(!row[5]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      location,binid,type,cday,ctime,vendor,amount,status <br /><br />
