...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/lpubreviewsdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getlpubreviewscount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getlpubreviewssecond', {
          params: {
            token: token,
            colid: colid,
            user: user
