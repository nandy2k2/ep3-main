...
return;
  ...
  const searchapi = async (rownumber,struture,description,businessrole,paycommission,designation,type,level,status1) => {
...
if(!row[2]){
f1=f1 + 'row ' + rownumber + '-' + 'Business role' + ',';
return;
}
if(!row[3]){
f1=f1 + 'row ' + rownumber + '-' + 'Pay commission' + ',';
return;
}
if(!row[4]){
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      struture,description,businessrole,paycommission,designation,type,level,status <br /><br />
