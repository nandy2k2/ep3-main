...
return '';
    ...
    const fetchViewPage = async () => {
      const response = await ep1.get('/api/v2/mfaccoursesdocs', {
        params: {
          token: token,
          colid: colid,
          user: user
    ...
    const getgraphdata = async () => {
        const response = await ep1.get('/api/v2/getmfaccoursescount', {
          params: {
            token: token,
            colid: colid,
            user: user
      ...
      const getgraphdatasecond = async () => {
        const response = await ep1.get('/api/v2/getmfaccoursessecond', {
          params: {
            token: token,
            colid: colid,
            user: user
