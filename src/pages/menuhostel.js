...
export function menuitemshostel() {
...
{open && <ListItemText primaryTypographyProps={{fontSize: "14px"}} primary="Hostel" />}
        ...
        <AccordionSummary aria-controls="panel3-content" id="panel3-header">
          <BusinessIcon sx={{ marginRight: 1 }} />
          {open && <Typography sx={{fontSize: 14}}>LMS and CO attainment</Typography>}
        </AccordionSummary>
        <AccordionDetails>
...
{open && <ListItemText primaryTypographyProps={{fontSize: "14px"}} primary="My courses" />}
  ...
  <Accordion>
        <AccordionSummary aria-controls="panel3-content" id="panel3-header">
          <BusinessIcon sx={{ marginRight: 1 }} />
          {open && <Typography sx={{fontSize: 14}}>Attendance and Class Schedule</Typography>}
        </AccordionSummary>
        <AccordionDetails>
