...
const examslot=examslotref.current.value;
...
//alert(coursetitle + '-' + dateadded);
    ...
    //setLoading(true);
    //setIsuploading(true);
    const response = await ep1.get('/api/v2/createexamtimetablebyfac', {
        params: {
            user: user,
            token: token,
            colid: colid,
...
<TextField id="outlined-basic"  type="String" sx={{ width: "100%"}} label="Exam code"  variant="outlined" inputRef={examcoderef} /><br /><br />

<TextField id="outlined-basic"  type="Date" sx={{ width: "100%"}} label="Exam date"  variant="outlined" inputRef={examdateref} /><br /><br />

<TextField id="outlined-basic"  type="String" sx={{ width: "100%"}} label="Exam time slot"  variant="outlined" inputRef={examslotref} /><br /><br />
...
<TextField id="outlined-basic"  type="String" sx={{ width: "100%"}} label="Course code"  variant="outlined" inputRef={coursecoderef} /><br /><br />

<InputLabel id="type">Semester / Year</InputLabel><Select labelId="type"
id="type"
inputRef={typeref}
sx={{ width: '100%'}}
>
