...
return;
  ...
  const searchapi = async (rownumber,itemname,itemcode,itemtype,description,image,status,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      itemname,itemcode,itemtype,description,image,status,status <br /><br />
