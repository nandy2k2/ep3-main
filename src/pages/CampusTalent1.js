...
const AboutPage = () => {
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, alignItems: 'center', gap: 10, padding: 6, marginBlock: "80px" }}>
            ...
            <Box sx={{ width: "65%", }}>
            {/* <Button variant="contained" style={{alignSelf: 'center'}}>Register for exam</Button> */}
            <a href='/campustalentregister1' style={{ backgroundColor: '#0f6fdb', color: '#fff', display: 'block', padding: 15, width: 100, fontSize: 16, textDecoration: 'none' }}>
                            Register
                        </a>
            <br /><br />
...
function CampusWebsite(props) {
    ...
    const onButtonClickregister = async () => {
      navigate('/campustalentregister1');
  };
    ...
    const drawer = (
        <Box onClick={handleDrawerToggle} sx={{ textAlign: "center" }}>
            ...
            <List>
                ...
                <ListItem disablePadding component={RouterLink} to="/campustalentregister1">
                    <ListItemButton sx={{ textAlign: "center" }}>
        ...
        <Box sx={{ display: "flex", }}>
            ...
            <Box sx={{ width: "100%" }}>
                <Box sx={{ position: "relative", maxWidth: "1500px", margin: "auto", marginTop: "64px" }}>
                    ...
                    >
                        <iframe width="100%" height="315" src="https://www.youtube.com/embed/yerXmC9xriM?si=ASFp_eAeB1dyWyyz" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

                        <br /><br />
                        <div style={{ alignSelf: 'center', alignItems: 'center', paddingLeft: 10}}>
                        Round 1 exam on Dec 20 2024, Round 2 exam on Jan 19 2024.
                        <br /><br />
                        <a href='/campustalentregister1' style={{ backgroundColor: '#0f6fdb', color: '#fff', display: 'block', padding: 15, width: 185, fontSize: 16, textDecoration: 'none' }}>
                            Register for exam
                        </a>
                        <br /><br />
                        </div>
                    ...
                    <Container>
                        ...
                        >
                            <Box>
                                ...
                                >
                                    Registration fee Rs. 200 for Round 1 and Rs. 200 for Round 2 per exam
                                </Typography>
                                <br /><br />
